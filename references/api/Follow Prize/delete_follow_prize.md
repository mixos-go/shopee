...
api_name: delete_follow_prize
url: "https://open.shopee.com/documents/v2/v2.follow_prize.delete_follow_prize?module=113&type=1"
...
**Category:** FOLLOW_PRIZE
**API:** delete_follow_prize

**Method:** POST
**HTTP Path:** /api/v2/follow_prize/delete_follow_prize
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/follow_prize/delete_follow_prize |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/follow_prize/delete_follow_prize |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/follow_prize/delete_follow_prize |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/follow_prize/delete_follow_prize |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/follow_prize/delete_follow_prize |
...
| --- | --- | --- | --- | --- |
| campaign_id | int32 | True | 24255 | The unique identifier for the created follow prize. |
