...
category: sbs
api_name: get_stock_aging
url: "https://open.shopee.com/documents/v2/v2.sbs.get_stock_aging?module=124&type=1"
...
**Method:** GET
**HTTP Path:** /api/v2/sbs/get_stock_aging
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/sbs/get_stock_aging |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/sbs/get_stock_aging |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/sbs/get_stock_aging |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/sbs/get_stock_aging |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/sbs/get_stock_aging |
...
| search_type | int32 | False | 2 | 1-Product Name；2-SKU ID；3-Variations；4-Item ID |
| keyword | string | False |  | bound with search_type |
| whs_ids | string | False | IDL,IDG | split by comma |
| aging_storage_tag | int32 | False | 0 | 0-false；1-true |
| excess_storage_tag | int32 | False | 0 | 0-false；1-true |
| category_id | int64 | False | 100002 | L1-level product category ID. You need to call the get_category API to obtain the first-level category_id |
| whs_region | string | True | CN | BR、CN、ID、MY、MX、TH、TW、PH、VN、SG If do not pass, will get error "block by gateway due to invalid cid" |
...
| warehouse_item_id | string | 900626943 | Warehouse item id; To indicate an unique item in a warehouse one warehouse item id can match with multiple shop_item_id For Global Item, warehouse_item_id=Global Item id For Local Item, shop_item_id=item_id |
...
| model_id | string | 15359982 | Warehouse model SKU ID For CB global items, this is equal to the global model_id. For local items, it differs from model_id; use shop_model_id to match the model_id |
