...
category: sbs
api_name: get_bound_whs_info
url: "https://open.shopee.com/documents/v2/v2.sbs.get_bound_whs_info?module=124&type=1"
...
**Category:** SBS
**API:** get_bound_whs_info

**Method:** GET
**HTTP Path:** /api/v2/sbs/get_bound_whs_info
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/sbs/get_bound_whs_info |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/sbs/get_bound_whs_info |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/sbs/get_bound_whs_info |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/sbs/get_bound_whs_info |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/sbs/get_bound_whs_info |
