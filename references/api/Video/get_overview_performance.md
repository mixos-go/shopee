...
category: video
api_name: get_overview_performance
url: "https://open.shopee.com/documents/v2/v2.video.get_overview_performance?module=129&type=1"
...
**Category:** VIDEO
**API:** get_overview_performance

**Method:** GET
**HTTP Path:** /api/v2/video/get_overview_performance
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/video/get_overview_performance |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/video/get_overview_performance |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/video/get_overview_performance |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/video/get_overview_performance |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/video/get_overview_performance |
...
| --- | --- | --- | --- | --- |
| period_type | string | True | Month | Period Type. Applicable values: Day Week Month Last7d Last15d Last30d Note: The end date must align with the Period Type. |
...
HttpResponse<String> response = Unirest.get("https://partner.shopeemobile.com/api/v2/video/get_overview_performance?access_token=access_token&end_date=2025-09-30&partner_id=partner_id&period_type=Month&sign=sign&timestamp=timestamp&user_id=user_id")
.asString();
```
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.shopeemobile.com/api/v2/video/get_overview_performance?access_token=access_token&end_date=2025-09-30&partner_id=partner_id&period_type=Month&sign=sign&timestamp=timestamp&user_id=user_id',
