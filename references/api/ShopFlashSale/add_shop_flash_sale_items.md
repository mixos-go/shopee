...
api_name: add_shop_flash_sale_items
url: "https://open.shopee.com/documents/v2/v2.shop_flash_sale.add_shop_flash_sale_items?module=123&type=1"
...
**Category:** SHOP_FLASH_SALE
**API:** add_shop_flash_sale_items

**Method:** POST
**HTTP Path:** /api/v2/shop_flash_sale/add_shop_flash_sale_items
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/shop_flash_sale/add_shop_flash_sale_items |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/shop_flash_sale/add_shop_flash_sale_items |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/shop_flash_sale/add_shop_flash_sale_items |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/shop_flash_sale/add_shop_flash_sale_items |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/shop_flash_sale/add_shop_flash_sale_items |
...
| items | object[] | True |  |  |
| item_id | int64 | True |  |  |
| purchase_limit | int32 | True |  | min=0, 0 means no limit |
| models | object[] | False |  | If the item has variation, this param is necessary. |
| model_id | int64 | True |  | If the item has variation, this param is necessary. |
| input_promo_price | float | True |  | promotion price without tax |
| stock | int32 | True |  | min=1, Campaign Stock, Campaign stock can only be reserved from either Shopee stock or Seller stock |
| item_input_promo_price | float | False |  | promotion price without tax of the item. If the item has no variation, this param is necessary, otherwise don't use this field |
| item_stock | int32 | False |  | min=1, The campaign stock of the item. If the item has no variation, this param is necessary, otherwise don't use this field |
