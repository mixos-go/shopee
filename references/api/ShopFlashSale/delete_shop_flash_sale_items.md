...
api_name: delete_shop_flash_sale_items
url: "https://open.shopee.com/documents/v2/v2.shop_flash_sale.delete_shop_flash_sale_items?module=123&type=1"
...
**Category:** SHOP_FLASH_SALE
**API:** delete_shop_flash_sale_items

**Method:** POST
**HTTP Path:** /api/v2/shop_flash_sale/delete_shop_flash_sale_items
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/shop_flash_sale/delete_shop_flash_sale_items |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/shop_flash_sale/delete_shop_flash_sale_items |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/shop_flash_sale/delete_shop_flash_sale_items |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/shop_flash_sale/delete_shop_flash_sale_items |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/shop_flash_sale/delete_shop_flash_sale_items |
...
| item_ids | int64[] | True |  | if you delete a item, will delete all models of the item |
