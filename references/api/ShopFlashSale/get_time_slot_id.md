...
api_name: get_time_slot_id
url: "https://open.shopee.com/documents/v2/v2.shop_flash_sale.get_time_slot_id?module=123&type=1"
...
**Category:** SHOP_FLASH_SALE
**API:** get_time_slot_id

**Method:** GET
**HTTP Path:** /api/v2/shop_flash_sale/get_time_slot_id
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/shop_flash_sale/get_time_slot_id |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/shop_flash_sale/get_time_slot_id |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/shop_flash_sale/get_time_slot_id |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/shop_flash_sale/get_time_slot_id |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/shop_flash_sale/get_time_slot_id |
...
| --- | --- | --- | --- | --- |
| start_time | timestamp | True | 1721978628 | min = now, max=2145887999, should be < end_time |
| end_time | timestamp | True | 1727335428 | should be > start_time, max=2145887999 |
