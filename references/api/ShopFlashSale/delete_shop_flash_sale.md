...
api_name: delete_shop_flash_sale
url: "https://open.shopee.com/documents/v2/v2.shop_flash_sale.delete_shop_flash_sale?module=123&type=1"
...
**Category:** SHOP_FLASH_SALE
**API:** delete_shop_flash_sale

**Method:** POST
**HTTP Path:** /api/v2/shop_flash_sale/delete_shop_flash_sale
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/shop_flash_sale/delete_shop_flash_sale |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/shop_flash_sale/delete_shop_flash_sale |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/shop_flash_sale/delete_shop_flash_sale |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/shop_flash_sale/delete_shop_flash_sale |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/shop_flash_sale/delete_shop_flash_sale |
...
| --- | --- | --- | --- | --- |
| flash_sale_id | int64 | True |  | cannot delete ongoing and expired shop flash sale |
...
| timeslot_id | int64 |  |  |
| flash_sale_id | int64 |  |  |
| status | int32 | 0 | the status of shop flash sale 0: deleted 1: enabled 2: disabled 3: system_rejected |
