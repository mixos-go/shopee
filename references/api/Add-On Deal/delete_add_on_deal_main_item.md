...
api_name: delete_add_on_deal_main_item
url: "https://open.shopee.com/documents/v2/v2.add_on_deal.delete_add_on_deal_main_item?module=111&type=1"
...
**Category:** ADD_ON_DEAL
**API:** delete_add_on_deal_main_item

**Method:** POST
**HTTP Path:** /api/v2/add_on_deal/delete_add_on_deal_main_item
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/add_on_deal/delete_add_on_deal_main_item |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/add_on_deal/delete_add_on_deal_main_item |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/add_on_deal/delete_add_on_deal_main_item |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/add_on_deal/delete_add_on_deal_main_item |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/add_on_deal/delete_add_on_deal_main_item |
...
| --- | --- | --- | --- | --- |
| add_on_deal_id | int | True | 12068 | Shopee's unique identifier for add on deal activity. |
| main_item_list | int[] | True | [100197906] | The main items added in this add on deal promotion. |
