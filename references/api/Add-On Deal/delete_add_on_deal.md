...
api_name: delete_add_on_deal
url: "https://open.shopee.com/documents/v2/v2.add_on_deal.delete_add_on_deal?module=111&type=1"
...
**Category:** ADD_ON_DEAL
**API:** delete_add_on_deal

**Method:** POST
**HTTP Path:** /api/v2/add_on_deal/delete_add_on_deal
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/add_on_deal/delete_add_on_deal |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/add_on_deal/delete_add_on_deal |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/add_on_deal/delete_add_on_deal |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/add_on_deal/delete_add_on_deal |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/add_on_deal/delete_add_on_deal |
...
| --- | --- | --- | --- | --- |
| add_on_deal_id | int | True | 11223123 | Shopee's unique identifier for an add on deal activity. |
