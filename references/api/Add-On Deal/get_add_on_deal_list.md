...
url: "https://open.shopee.com/documents/v2/v2.add_on_deal.get_add_on_deal_list?module=111&type=1"
...
**Category:** ADD_ON_DEAL
**API:** get_add_on_deal_list

**Method:** GET
**HTTP Path:** /api/v2/add_on_deal/get_add_on_deal_list
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/add_on_deal/get_add_on_deal_list |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/add_on_deal/get_add_on_deal_list |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/add_on_deal/get_add_on_deal_list |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/add_on_deal/get_add_on_deal_list |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/add_on_deal/get_add_on_deal_list |
...
| --- | --- | --- | --- | --- |
| promotion_status | string | True | all | The Status of add on deal，default status is all |
| page_no | int | False | 1 | The default page number is 1 |
| page_size | int | False | 100 | The default page size is 100 |
