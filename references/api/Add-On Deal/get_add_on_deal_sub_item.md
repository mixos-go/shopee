...
url: "https://open.shopee.com/documents/v2/v2.add_on_deal.get_add_on_deal_sub_item?module=111&type=1"
...
**Category:** ADD_ON_DEAL
**API:** get_add_on_deal_sub_item

**Method:** GET
**HTTP Path:** /api/v2/add_on_deal/get_add_on_deal_sub_item
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/add_on_deal/get_add_on_deal_sub_item |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/add_on_deal/get_add_on_deal_sub_item |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/add_on_deal/get_add_on_deal_sub_item |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/add_on_deal/get_add_on_deal_sub_item |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/add_on_deal/get_add_on_deal_sub_item |
