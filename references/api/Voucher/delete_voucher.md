...
category: voucher
api_name: delete_voucher
url: "https://open.shopee.com/documents/v2/v2.voucher.delete_voucher?module=112&type=1"
...
**Method:** POST
**HTTP Path:** /api/v2/voucher/delete_voucher
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/voucher/delete_voucher |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/voucher/delete_voucher |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/voucher/delete_voucher |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/voucher/delete_voucher |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/voucher/delete_voucher |
...
| --- | --- | --- | --- | --- |
| voucher_id | int64 | True | 1104340665 | The unique identifier for the voucher you want to delete. |
