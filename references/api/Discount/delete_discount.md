...
category: discount
api_name: delete_discount
url: "https://open.shopee.com/documents/v2/v2.discount.delete_discount?module=99&type=1"
...
**Method:** POST
**HTTP Path:** /api/v2/discount/delete_discount
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/discount/delete_discount |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/discount/delete_discount |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/discount/delete_discount |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/discount/delete_discount |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/discount/delete_discount |
