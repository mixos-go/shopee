...
category: discount
api_name: add_discount
url: "https://open.shopee.com/documents/v2/v2.discount.add_discount?module=99&type=1"
...
**Method:** POST
**HTTP Path:** /api/v2/discount/add_discount
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/discount/add_discount |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/discount/add_discount |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/discount/add_discount |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/discount/add_discount |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/discount/add_discount |
...
| --- | --- | --- | --- | --- |
| discount_name | string | True | test-create | Title of the discount. |
| start_time | timestamp | True | 1624864213 | The time when discount activity start.The start time must be 1 hour later than current time. |
| end_time | timestamp | True | 1625382613 | The time when discount activity end.The end time must be 1 hour later than start time,and the discount period must be less than 180 days. |
