...
category: discount
api_name: end_discount
url: "https://open.shopee.com/documents/v2/v2.discount.end_discount?module=99&type=1"
...
**Method:** POST
**HTTP Path:** /api/v2/discount/end_discount
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/discount/end_discount |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/discount/end_discount |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/discount/end_discount |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/discount/end_discount |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/discount/end_discount |
...
| --- | --- | --- | --- | --- |
| discount_id | int | True | 66512366666549900 | Shopee's unique identifier for a discount activity. |
