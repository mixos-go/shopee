...
category: discount
api_name: delete_discount_item
url: "https://open.shopee.com/documents/v2/v2.discount.delete_discount_item?module=99&type=1"
...
**Category:** DISCOUNT
**API:** delete_discount_item

**Method:** POST
**HTTP Path:** /api/v2/discount/delete_discount_item
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/discount/delete_discount_item |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/discount/delete_discount_item |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/discount/delete_discount_item |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/discount/delete_discount_item |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/discount/delete_discount_item |
...
| --- | --- | --- | --- | --- |
| discount_id | int | True | 665123666665499 | Shopee's unique identifier for a discount activity. |
| item_id | int | True | 1776783 | Shopee's unique identifier for an item. |
| model_id | int | False | 1467683 | Shopee's unique identifier for a variation of an item. If there is no variation of this item, you don't need to input this param. Dafault is 0. |
