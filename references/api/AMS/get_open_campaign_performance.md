...
category: ams
api_name: get_open_campaign_performance
url: "https://open.shopee.com/documents/v2/v2.ams.get_open_campaign_performance?module=127&type=1"
...
**Category:** AMS
**API:** get_open_campaign_performance

**Method:** GET
**HTTP Path:** /api/v2/ams/get_open_campaign_performance
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/ams/get_open_campaign_performance |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/ams/get_open_campaign_performance |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/ams/get_open_campaign_performance |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ams/get_open_campaign_performance |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/ams/get_open_campaign_performance |
...
| item_id | int64 | False |  | Item ID for query. |
...
HttpResponse<String> response = Unirest.get("https://partner.shopeemobile.com/api/v2/ams/get_open_campaign_performance?access_token=access_token&end_date=20250831&item_id=0&page_no=1&page_size=20&partner_id=partner_id&period_type=Last30d&shop_id=shop_id&sign=sign&start_date=20250801&timestamp=timestamp")
.asString();
```
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.shopeemobile.com/api/v2/ams/get_open_campaign_performance?access_token=access_token&end_date=20250831&item_id=0&page_no=1&page_size=20&partner_id=partner_id&period_type=Last30d&shop_id=shop_id&sign=sign&start_date=20250801&timestamp=timestamp',
