...
category: ams
api_name: terminate_targeted_campaign
url: "https://open.shopee.com/documents/v2/v2.ams.terminate_targeted_campaign?module=127&type=1"
...
**Category:** AMS
**API:** terminate_targeted_campaign

**Method:** POST
**HTTP Path:** /api/v2/ams/terminate_targeted_campaign
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/ams/terminate_targeted_campaign |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/ams/terminate_targeted_campaign |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/ams/terminate_targeted_campaign |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ams/terminate_targeted_campaign |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/ams/terminate_targeted_campaign |
...
HttpResponse<String> response = Unirest.post("https://partner.shopeemobile.com/api/v2/ams/terminate_targeted_campaign?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.shopeemobile.com/api/v2/ams/terminate_targeted_campaign?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp',
...
```bash
curl --location --request POST 'https://partner.shopeemobile.com/api/v2/ams/terminate_targeted_campaign?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp' \
--header 'Content-Type: application/json' \
--data-raw '{
   "campaign_id": 101
}'
