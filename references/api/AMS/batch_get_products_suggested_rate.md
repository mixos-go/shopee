...
category: ams
api_name: batch_get_products_suggested_rate
url: "https://open.shopee.com/documents/v2/v2.ams.batch_get_products_suggested_rate?module=127&type=1"
...
**Category:** AMS
**API:** batch_get_products_suggested_rate

**Method:** GET
**HTTP Path:** /api/v2/ams/batch_get_products_suggested_rate
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/ams/batch_get_products_suggested_rate |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/ams/batch_get_products_suggested_rate |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/ams/batch_get_products_suggested_rate |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ams/batch_get_products_suggested_rate |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/ams/batch_get_products_suggested_rate |
...
| --- | --- | --- | --- | --- |
| item_id_list | string | True | 1,12,123 | The list of item_id, different item id should be split by comma and at most 20 items |
...
HttpResponse<String> response = Unirest.get("https://partner.shopeemobile.com/api/v2/ams/batch_get_products_suggested_rate?access_token=access_token&item_id_list=1%2C12%2C123&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp")
.asString();
```
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.shopeemobile.com/api/v2/ams/batch_get_products_suggested_rate?access_token=access_token&item_id_list=1%2C12%2C123&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp',
