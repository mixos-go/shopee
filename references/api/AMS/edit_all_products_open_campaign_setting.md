...
category: ams
api_name: edit_all_products_open_campaign_setting
url: "https://open.shopee.com/documents/v2/v2.ams.edit_all_products_open_campaign_setting?module=127&type=1"
...
**Category:** AMS
**API:** edit_all_products_open_campaign_setting

**Method:** POST
**HTTP Path:** /api/v2/ams/edit_all_products_open_campaign_setting
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/ams/edit_all_products_open_campaign_setting |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/ams/edit_all_products_open_campaign_setting |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/ams/edit_all_products_open_campaign_setting |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ams/edit_all_products_open_campaign_setting |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/ams/edit_all_products_open_campaign_setting |
...
| --- | --- | --- | --- | --- |
| commission_rate | float | False | 1.1 | Commission Rate, 1.1 means 1.1%, support two decimal places, if miss, will skip and do not update |
...
```bash
curl --location --request POST 'https://partner.shopeemobile.com/api/v2/ams/edit_all_products_open_campaign_setting?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp' \
--header 'Content-Type: application/json' \
--data-raw '{
   "commission_rate": 1.1,
   "period_end_time": 1735660800,
...
| response | object |  |  |
| task_type | string | batch_update_open_campaigns | Task type. Applicable values: batch_add_open_campaigns batch_remove_open_campaigns batch_update_open_campaigns For this API, task type will be batch_update_open_campaigns |
