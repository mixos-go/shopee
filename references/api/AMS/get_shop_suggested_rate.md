...
category: ams
api_name: get_shop_suggested_rate
url: "https://open.shopee.com/documents/v2/v2.ams.get_shop_suggested_rate?module=127&type=1"
...
**Category:** AMS
**API:** get_shop_suggested_rate

**Method:** GET
**HTTP Path:** /api/v2/ams/get_shop_suggested_rate
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/ams/get_shop_suggested_rate |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/ams/get_shop_suggested_rate |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/ams/get_shop_suggested_rate |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ams/get_shop_suggested_rate |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/ams/get_shop_suggested_rate |
...
HttpResponse<String> response = Unirest.get("https://partner.shopeemobile.com/api/v2/ams/get_shop_suggested_rate?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp")
.asString();
```
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.shopeemobile.com/api/v2/ams/get_shop_suggested_rate?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp',
