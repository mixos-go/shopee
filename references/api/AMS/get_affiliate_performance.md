...
category: ams
api_name: get_affiliate_performance
url: "https://open.shopee.com/documents/v2/v2.ams.get_affiliate_performance?module=127&type=1"
...
**Category:** AMS
**API:** get_affiliate_performance

**Method:** GET
**HTTP Path:** /api/v2/ams/get_affiliate_performance
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/ams/get_affiliate_performance |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/ams/get_affiliate_performance |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/ams/get_affiliate_performance |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ams/get_affiliate_performance |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/ams/get_affiliate_performance |
...
| affiliate_id | int64 | False | 16142330000 | Affiliate ID for query. |
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.shopeemobile.com/api/v2/ams/get_affiliate_performance?access_token=access_token&affiliate_id=16142330000&channel=AllChannel&end_date=20250831&order_type=ConfirmedOrder&page_no=1&page_size=20&partner_id=partner_id&period_type=Last30d&shop_id=shop_id&sign=sign&start_date=20250801&timestamp=timestamp',
