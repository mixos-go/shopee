...
category: ams
api_name: get_auto_add_new_product_toggle_status
url: "https://open.shopee.com/documents/v2/v2.ams.get_auto_add_new_product_toggle_status?module=127&type=1"
...
**Category:** AMS
**API:** get_auto_add_new_product_toggle_status

**Method:** GET
**HTTP Path:** /api/v2/ams/get_auto_add_new_product_toggle_status
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/ams/get_auto_add_new_product_toggle_status |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/ams/get_auto_add_new_product_toggle_status |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/ams/get_auto_add_new_product_toggle_status |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ams/get_auto_add_new_product_toggle_status |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/ams/get_auto_add_new_product_toggle_status |
...
HttpResponse<String> response = Unirest.get("https://partner.shopeemobile.com/api/v2/ams/get_auto_add_new_product_toggle_status?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp")
.asString();
```
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.shopeemobile.com/api/v2/ams/get_auto_add_new_product_toggle_status?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp',
