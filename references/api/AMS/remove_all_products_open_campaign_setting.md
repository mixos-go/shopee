...
category: ams
api_name: remove_all_products_open_campaign_setting
url: "https://open.shopee.com/documents/v2/v2.ams.remove_all_products_open_campaign_setting?module=127&type=1"
...
**Category:** AMS
**API:** remove_all_products_open_campaign_setting

**Method:** POST
**HTTP Path:** /api/v2/ams/remove_all_products_open_campaign_setting
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/ams/remove_all_products_open_campaign_setting |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/ams/remove_all_products_open_campaign_setting |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/ams/remove_all_products_open_campaign_setting |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ams/remove_all_products_open_campaign_setting |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/ams/remove_all_products_open_campaign_setting |
...
HttpResponse<String> response = Unirest.post("https://partner.shopeemobile.com/api/v2/ams/remove_all_products_open_campaign_setting?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp")
.asString();
```
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.shopeemobile.com/api/v2/ams/remove_all_products_open_campaign_setting?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp',
...
```bash
curl --location --request POST 'https://partner.shopeemobile.com/api/v2/ams/remove_all_products_open_campaign_setting?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp'
```
...
| response | object |  |  |
| task_type | string | batch_remove_open_campaigns | Task type. Applicable values: batch_add_open_campaigns batch_remove_open_campaigns batch_update_open_campaigns For this API, task type will be batch_remove_open_campaigns |
