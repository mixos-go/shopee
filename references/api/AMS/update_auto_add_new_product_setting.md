...
category: ams
api_name: update_auto_add_new_product_setting
url: "https://open.shopee.com/documents/v2/v2.ams.update_auto_add_new_product_setting?module=127&type=1"
...
**Category:** AMS
**API:** update_auto_add_new_product_setting

**Method:** POST
**HTTP Path:** /api/v2/ams/update_auto_add_new_product_setting
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/ams/update_auto_add_new_product_setting |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/ams/update_auto_add_new_product_setting |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/ams/update_auto_add_new_product_setting |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ams/update_auto_add_new_product_setting |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/ams/update_auto_add_new_product_setting |
...
| --- | --- | --- | --- | --- |
| open | boolean | True | true | Enable or disable auto-add new product, if true is passed, it means enabled, if false is passed, it means disabled |
...
HttpResponse<String> response = Unirest.post("https://partner.shopeemobile.com/api/v2/ams/update_auto_add_new_product_setting?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.shopeemobile.com/api/v2/ams/update_auto_add_new_product_setting?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp',
...
```bash
curl --location --request POST 'https://partner.shopeemobile.com/api/v2/ams/update_auto_add_new_product_setting?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp' \
--header 'Content-Type: application/json' \
--data-raw '{
   "commission_rate": 1.1,
   "open": true
