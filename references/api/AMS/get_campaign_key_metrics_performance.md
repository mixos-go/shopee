...
category: ams
api_name: get_campaign_key_metrics_performance
url: "https://open.shopee.com/documents/v2/v2.ams.get_campaign_key_metrics_performance?module=127&type=1"
...
**Category:** AMS
**API:** get_campaign_key_metrics_performance

**Method:** GET
**HTTP Path:** /api/v2/ams/get_campaign_key_metrics_performance
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/ams/get_campaign_key_metrics_performance |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/ams/get_campaign_key_metrics_performance |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/ams/get_campaign_key_metrics_performance |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ams/get_campaign_key_metrics_performance |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/ams/get_campaign_key_metrics_performance |
...
HttpResponse<String> response = Unirest.get("https://partner.shopeemobile.com/api/v2/ams/get_campaign_key_metrics_performance?access_token=access_token&end_date=20250831&partner_id=partner_id&period_type=Last30d&shop_id=shop_id&sign=sign&start_date=20250801&timestamp=timestamp")
.asString();
```
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.shopeemobile.com/api/v2/ams/get_campaign_key_metrics_performance?access_token=access_token&end_date=20250831&partner_id=partner_id&period_type=Last30d&shop_id=shop_id&sign=sign&start_date=20250801&timestamp=timestamp',
