...
category: ams
api_name: get_performance_data_update_time
url: "https://open.shopee.com/documents/v2/v2.ams.get_performance_data_update_time?module=127&type=1"
...
**Category:** AMS
**API:** get_performance_data_update_time

**Method:** GET
**HTTP Path:** /api/v2/ams/get_performance_data_update_time
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/ams/get_performance_data_update_time |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/ams/get_performance_data_update_time |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/ams/get_performance_data_update_time |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ams/get_performance_data_update_time |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/ams/get_performance_data_update_time |
...
| --- | --- | --- | --- | --- |
| marker_type | string | True | AmsMarker | Marker type. Applicable values: - AmsMarker: Used to query the data update date for ams metrics. |
...
HttpResponse<String> response = Unirest.get("https://partner.shopeemobile.com/api/v2/ams/get_performance_data_update_time?access_token=access_token&marker_type=AmsMarker&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp")
.asString();
```
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.shopeemobile.com/api/v2/ams/get_performance_data_update_time?access_token=access_token&marker_type=AmsMarker&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp',
