...
category: ams
api_name: get_product_performance
url: "https://open.shopee.com/documents/v2/v2.ams.get_product_performance?module=127&type=1"
...
**Category:** AMS
**API:** get_product_performance

**Method:** GET
**HTTP Path:** /api/v2/ams/get_product_performance
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/ams/get_product_performance |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/ams/get_product_performance |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/ams/get_product_performance |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ams/get_product_performance |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/ams/get_product_performance |
...
| item_id | int64 | False | 123 | Item ID for query. |
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.shopeemobile.com/api/v2/ams/get_product_performance?access_token=access_token&channel=AllChannel&end_date=20250831&item_id=123&order_type=ConfirmedOrder&page_no=1&page_size=20&partner_id=partner_id&period_type=Last30d&shop_id=shop_id&sign=sign&start_date=20250801&timestamp=timestamp',
