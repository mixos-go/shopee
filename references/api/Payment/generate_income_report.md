...
category: payment
api_name: generate_income_report
url: "https://open.shopee.com/documents/v2/v2.payment.generate_income_report?module=97&type=1"
...
**Category:** PAYMENT
**API:** generate_income_report

**Method:** GET
**HTTP Path:** /api/v2/payment/generate_income_report
