...
category: payment
api_name: get_item_installment_status
url: "https://open.shopee.com/documents/v2/v2.payment.get_item_installment_status?module=97&type=1"
...
**Category:** PAYMENT
**API:** get_item_installment_status

**Method:** POST
**HTTP Path:** /api/v2/payment/get_item_installment_status
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/payment/get_item_installment_status |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/payment/get_item_installment_status |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/payment/get_item_installment_status |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/payment/get_item_installment_status |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/payment/get_item_installment_status |
...
| --- | --- | --- | --- | --- |
| item_id_list | int[] | True |  | Item id array, Max :100 |
