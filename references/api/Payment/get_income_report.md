...
category: payment
api_name: get_income_report
url: "https://open.shopee.com/documents/v2/v2.payment.get_income_report?module=97&type=1"
domain: open.shopee.com
date_saved: "2026-09-03 09:13:02"
...
**Category:** PAYMENT
**API:** get_income_report

**Method:** GET
**HTTP Path:** /api/v2/payment/get_income_report
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/payment/get_income_report |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/payment/get_income_report |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/payment/get_income_report |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/payment/get_income_report |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/payment/get_income_report |
...
| --- | --- | --- | --- | --- |
| income_report_id | int64 | True | 123456 | The identifier for income report file request. |
