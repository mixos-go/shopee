...
category: payment
api_name: set_shop_installment_status
url: "https://open.shopee.com/documents/v2/v2.payment.set_shop_installment_status?module=97&type=1"
domain: open.shopee.com
date_saved: "2026-09-03 09:12:56"
...
**Category:** PAYMENT
**API:** set_shop_installment_status

**Method:** POST
**HTTP Path:** /api/v2/payment/set_shop_installment_status
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/payment/set_shop_installment_status |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/payment/set_shop_installment_status |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/payment/set_shop_installment_status |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/payment/set_shop_installment_status |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/payment/set_shop_installment_status |
...
| --- | --- | --- | --- | --- |
| installment_status | int | True | 0 | The status of installment contains 1 and 0. |
