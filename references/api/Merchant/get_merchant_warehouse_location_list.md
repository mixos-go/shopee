...
category: merchant
api_name: get_merchant_warehouse_location_list
url: "https://open.shopee.com/documents/v2/v2.merchant.get_merchant_warehouse_location_list?module=93&type=1"
...
**Category:** MERCHANT
**API:** get_merchant_warehouse_location_list

**Method:** GET
**HTTP Path:** /api/v2/merchant/get_merchant_warehouse_location_list
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/merchant/get_merchant_warehouse_location_list |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/merchant/get_merchant_warehouse_location_list |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/merchant/get_merchant_warehouse_location_list |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/merchant/get_merchant_warehouse_location_list |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/merchant/get_merchant_warehouse_location_list |
