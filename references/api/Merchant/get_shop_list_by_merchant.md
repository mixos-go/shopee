...
category: merchant
api_name: get_shop_list_by_merchant
url: "https://open.shopee.com/documents/v2/v2.merchant.get_shop_list_by_merchant?module=93&type=1"
...
**Category:** MERCHANT
**API:** get_shop_list_by_merchant

**Method:** GET
**HTTP Path:** /api/v2/merchant/get_shop_list_by_merchant
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/merchant/get_shop_list_by_merchant |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/merchant/get_shop_list_by_merchant |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/merchant/get_shop_list_by_merchant |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/merchant/get_shop_list_by_merchant |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/merchant/get_shop_list_by_merchant |
