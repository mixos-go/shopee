...
category: merchant
api_name: get_warehouse_eligible_shop_list
url: "https://open.shopee.com/documents/v2/v2.merchant.get_warehouse_eligible_shop_list?module=93&type=1"
...
**Category:** MERCHANT
**API:** get_warehouse_eligible_shop_list

**Method:** POST
**HTTP Path:** /api/v2/merchant/get_warehouse_eligible_shop_list
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/merchant/get_warehouse_eligible_shop_list |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/merchant/get_warehouse_eligible_shop_list |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/merchant/get_warehouse_eligible_shop_list |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/merchant/get_warehouse_eligible_shop_list |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/merchant/get_warehouse_eligible_shop_list |
...
| --- | --- | --- | --- | --- |
| warehouse_id | int | True |  | Warehouse address identifier. |
...
```bash
curl --location --request POST 'https://open.admin.shopee.io/api/v2/merchant/list_shop_by_warehouse?access_token=access_token&merchant_id=merchant_id&partner_id=partner_id&sign=sign&timestamp=timestamp' \
--header 'Content-Type: application/json' \
--data-raw '{
   "cursor": {},
   "warehouse_id": 100,
