...
api_name: search_global_attribute_value_list
url: "https://open.shopee.com/documents/v2/v2.global_product.search_global_attribute_value_list?module=90&type=1"
...
**Category:** GLOBAL_PRODUCT
**API:** search_global_attribute_value_list

**Method:** POST
**HTTP Path:** /api/v2/global_product/search_global_attribute_value_list
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/global_product/search_global_attribute_value_list |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/global_product/search_global_attribute_value_list |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/global_product/search_global_attribute_value_list |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/global_product/search_global_attribute_value_list |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/global_product/search_global_attribute_value_list |
