...
api_name: update_price
url: "https://open.shopee.com/documents/v2/v2.global_product.update_price?module=90&type=1"
domain: open.shopee.com
date_saved: "2026-09-03 09:12:06"
...
**Method:** POST
**HTTP Path:** /api/v2/global_product/update_price
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/global_product/update_price |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/global_product/update_price |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/global_product/update_price |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/global_product/update_price |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/global_product/update_price |
...
| --- | --- | --- | --- | --- |
| global_item_id | int | True | 2700143060 | ID of global item. |
| price_list | object[] | True |  | Price setting for global model. Limit is [1,50]. |
| global_model_id | int | False | 2000457157 | ID of global model. |
| original_price | float | True | 124.12 | Original price of global item. |
