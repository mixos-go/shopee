...
api_name: set_sync_field
url: "https://open.shopee.com/documents/v2/v2.global_product.set_sync_field?module=90&type=1"
...
**Method:** POST
**HTTP Path:** /api/v2/global_product/set_sync_field
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/global_product/set_sync_field |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/global_product/set_sync_field |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/global_product/set_sync_field |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/global_product/set_sync_field |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/global_product/set_sync_field |
...
| --- | --- | --- | --- | --- |
| shop_sync_list | object[] | True |  | Length limit is [1,50]. |
| shop_id | int | True | 1003698 | Id of shop. |
| shop_region | string | True | TW | TW TH MY BR IN SG VN |
| name_and_description | boolean | True |  | sync name and description |
| media_information | boolean | True |  | sync media information |
| tier_variation_name_and_option | boolean | True |  | sync tier variation |
| price | boolean | True |  | sync price |
| days_to_ship | boolean | True |  | sync days to ship info |
