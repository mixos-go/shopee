...
url: "https://open.shopee.com/documents/v2/v2.global_product.get_recommend_attribute?module=90&type=1"
...
**Method:** GET
**HTTP Path:** /api/v2/global_product/get_recommend_attribute
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/global_product/get_recommend_attribute |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/global_product/get_recommend_attribute |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/global_product/get_recommend_attribute |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/global_product/get_recommend_attribute |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/global_product/get_recommend_attribute |
...
| --- | --- | --- | --- | --- |
| global_item_name | string | True | iphone6s | Name of item. |
| category_id | int | True | 1065001 | ID of category. |
| cover_image_id | string | False | 30aa47695d1afb99e296956699f67be6 | ID of image. |
