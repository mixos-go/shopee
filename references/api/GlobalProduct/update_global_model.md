...
api_name: update_global_model
url: "https://open.shopee.com/documents/v2/v2.global_product.update_global_model?module=90&type=1"
...
**Category:** GLOBAL_PRODUCT
**API:** update_global_model

**Method:** POST
**HTTP Path:** /api/v2/global_product/update_global_model
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/global_product/update_global_model |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/global_product/update_global_model |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/global_product/update_global_model |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/global_product/update_global_model |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/global_product/update_global_model |
...
| --- | --- | --- | --- | --- |
| global_item_id | int64 | True | 28001436 | ID of global item. |
| global_model | object[] | True |  | Sku setting for global model. Limit is [1,50]. |
| global_model_sku | string | True | sku | Sku of global model. |
| global_model_id | int64 | True | 234431 | ID of global model. |
