...
api_name: get_publishable_shop
url: "https://open.shopee.com/documents/v2/v2.global_product.get_publishable_shop?module=90&type=1"
...
**Category:** GLOBAL_PRODUCT
**API:** get_publishable_shop

**Method:** GET
**HTTP Path:** /api/v2/global_product/get_publishable_shop
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/global_product/get_publishable_shop |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/global_product/get_publishable_shop |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/global_product/get_publishable_shop |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/global_product/get_publishable_shop |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/global_product/get_publishable_shop |
...
| --- | --- | --- | --- | --- |
| global_item_id | int | True | 3000141126 | Id of global item. |
| shop_id_list | int[] | False | [3000141126, 3000141127] | Shop id list for checking if the shop is publishable.If not input the list, will return the first 300 publishable shop list in response |
...
HttpResponse<String> response = Unirest.get("https://partner.shopeemobile.com/api/v2/global_product/get_publishable_shop?global_item_id=3000141126&merchant_id=merchant_id&partner_id=partner_id&access_token=access_token&timestamp=timestamp&sign=sign")
.asString();
```
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.shopeemobile.com/api/v2/global_product/get_publishable_shop?access_token=access_token&global_item_id=3000141126&merchant_id=merchant_id&partner_id=partner_id&sign=sign&timestamp=timestamp',
