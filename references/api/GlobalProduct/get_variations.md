...
url: "https://open.shopee.com/documents/v2/v2.global_product.get_variations?module=90&type=1"
...
**Method:** GET
**HTTP Path:** /api/v2/global_product/get_variations
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/global_product/get_variations |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/global_product/get_variations |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/global_product/get_variations |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/global_product/get_variations |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/global_product/get_variations |
