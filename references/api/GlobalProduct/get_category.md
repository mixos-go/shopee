...
url: "https://open.shopee.com/documents/v2/v2.global_product.get_category?module=90&type=1"
...
**Method:** GET
**HTTP Path:** /api/v2/global_product/get_category
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/global_product/get_category |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/global_product/get_category |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/global_product/get_category |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/global_product/get_category |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/global_product/get_category |
...
| --- | --- | --- | --- | --- |
| language | string | False | zh-hans | Display language. Language should be one of "zh-hans", "en" |
...
HttpResponse<String> response = Unirest.get("https://partner.shopeemobile.com/api/v2/global_product/get_category?sign=sign&merchant_id=merchant_id&partner_id=partner_id&language=zh-hans&access_token=access_token&timestamp=timestamp")
.asString();
```
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.shopeemobile.com/api/v2/global_product/get_category?access_token=access_token&language=zh-hans&merchant_id=merchant_id&partner_id=partner_id&sign=sign&timestamp=timestamp',
