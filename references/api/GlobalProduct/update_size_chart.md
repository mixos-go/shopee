...
api_name: update_size_chart
url: "https://open.shopee.com/documents/v2/v2.global_product.update_size_chart?module=90&type=1"
...
**Category:** GLOBAL_PRODUCT
**API:** update_size_chart

**Method:** POST
**HTTP Path:** /api/v2/global_product/update_size_chart
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/global_product/update_size_chart |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/global_product/update_size_chart |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/global_product/update_size_chart |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/global_product/update_size_chart |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/global_product/update_size_chart |
...
| size_chart | string | True | c54265d475b85e00ffb2404585e32b6f | Image id of size chart. |
