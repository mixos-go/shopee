...
api_name: get_local_adjustment_rate
url: "https://open.shopee.com/documents/v2/v2.global_product.get_local_adjustment_rate?module=90&type=1"
...
**Category:** GLOBAL_PRODUCT
**API:** get_local_adjustment_rate

**Method:** GET
**HTTP Path:** /api/v2/global_product/get_local_adjustment_rate
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/global_product/get_local_adjustment_rate |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/global_product/get_local_adjustment_rate |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/global_product/get_local_adjustment_rate |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/global_product/get_local_adjustment_rate |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/global_product/get_local_adjustment_rate |
...
| --- | --- | --- | --- | --- |
| shop_id | int64 | True |  | The unique identifier of the shop whose adjustment rate is being queried |
