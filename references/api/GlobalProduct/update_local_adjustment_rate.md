...
api_name: update_local_adjustment_rate
url: "https://open.shopee.com/documents/v2/v2.global_product.update_local_adjustment_rate?module=90&type=1"
domain: open.shopee.com
date_saved: "2026-09-03 09:12:10"
...
**Category:** GLOBAL_PRODUCT
**API:** update_local_adjustment_rate

**Method:** POST
**HTTP Path:** /api/v2/global_product/update_local_adjustment_rate
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/global_product/update_local_adjustment_rate |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/global_product/update_local_adjustment_rate |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/global_product/update_local_adjustment_rate |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/global_product/update_local_adjustment_rate |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/global_product/update_local_adjustment_rate |
...
| --- | --- | --- | --- | --- |
| adjustment_rate | float | True |  | The multiplier used to adjust the cross-border original price to local price |
| shop_id | int64 | True |  | The unique identifier of the shop to which the adjustment rate applies |
