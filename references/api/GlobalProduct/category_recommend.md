...
url: "https://open.shopee.com/documents/v2/v2.global_product.category_recommend?module=90&type=1"
domain: open.shopee.com
date_saved: "2026-09-03 09:12:07"
...
**Category:** GLOBAL_PRODUCT
**API:** category_recommend

**Method:** GET
**HTTP Path:** /api/v2/global_product/category_recommend
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/global_product/category_recommend |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/global_product/category_recommend |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/global_product/category_recommend |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/global_product/category_recommend |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/global_product/category_recommend |
...
| --- | --- | --- | --- | --- |
| global_item_name | string | True | Head | name of item |
| global_product_cover_image | string | False | 16bdad2c365f1fccea7664e69b696571 | Please use the image id returned by v2.media_space.upload_image api, we will ignore if this field is empty string |
...
HttpResponse<String> response = Unirest.get("https://partner.shopeemobile.com/api/v2/global_product/category_recommend?access_token=access_token&global_item_name=Head&merchant_id=merchant_id&partner_id=partner_id&sign=sign&timestamp=timestamp")
.asString();
```
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.shopeemobile.com/api/v2/global_product/category_recommend?access_token=access_token&global_item_name=Head&merchant_id=merchant_id&partner_id=partner_id&sign=sign&timestamp=timestamp',
