...
url: "https://open.shopee.com/documents/v2/v2.global_product.get_size_chart_detail?module=90&type=1"
...
**Method:** GET
**HTTP Path:** /api/v2/global_product/get_size_chart_detail
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/global_product/get_size_chart_detail |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/global_product/get_size_chart_detail |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/global_product/get_size_chart_detail |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/global_product/get_size_chart_detail |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/global_product/get_size_chart_detail |
...
| --- | --- | --- | --- | --- |
| size_chart_id | int32 | True | 700024639 |  |
| language | string | False | "en" | language should be in the list: ["en", "zh-Hans"] |
