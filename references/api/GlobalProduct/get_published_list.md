...
api_name: get_published_list
url: "https://open.shopee.com/documents/v2/v2.global_product.get_published_list?module=90&type=1"
...
**Category:** GLOBAL_PRODUCT
**API:** get_published_list

**Method:** GET
**HTTP Path:** /api/v2/global_product/get_published_list
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/global_product/get_published_list |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/global_product/get_published_list |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/global_product/get_published_list |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/global_product/get_published_list |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/global_product/get_published_list |
...
| shop_id_list | int[] | False | [220750716,220056389] | Shop id list for checking if the shop is publishable.If not input the list, will return the first 300 publishable shop list in response after the migration period. |
