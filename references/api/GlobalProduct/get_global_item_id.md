...
api_name: get_global_item_id
url: "https://open.shopee.com/documents/v2/v2.global_product.get_global_item_id?module=90&type=1"
...
**Category:** GLOBAL_PRODUCT
**API:** get_global_item_id

**Method:** GET
**HTTP Path:** /api/v2/global_product/get_global_item_id
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/global_product/get_global_item_id |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/global_product/get_global_item_id |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/global_product/get_global_item_id |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/global_product/get_global_item_id |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/global_product/get_global_item_id |
...
| --- | --- | --- | --- | --- |
| shop_id | int | True | 1889756 | Id of shop. |
| item_id_list | int[] | True | [1003698] | Item id list. Length limit is [1,20]. |
