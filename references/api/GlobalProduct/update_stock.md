...
url: "https://open.shopee.com/documents/v2/v2.global_product.update_stock?module=90&type=1"
...
**Method:** POST
**HTTP Path:** /api/v2/global_product/update_stock
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/global_product/update_stock |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/global_product/update_stock |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/global_product/update_stock |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/global_product/update_stock |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/global_product/update_stock |
...
| --- | --- | --- | --- | --- |
| global_item_id | int64 | True | 2700143060 | ID of global item. |
| stock_list | object[] | True |  | Stock setting for global model. Limit is [1,50]. |
| global_model_id | int64 | False | 123413 | ID of global model. |
| seller_stock | object[] | False |  |  |
