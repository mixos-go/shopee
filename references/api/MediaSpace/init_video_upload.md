...
url: "https://open.shopee.com/documents/v2/v2.media_space.init_video_upload?module=91&type=1"
...
**Method:** POST
**HTTP Path:** /api/v2/media_space/init_video_upload
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/media_space/init_video_upload |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/media_space/init_video_upload |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/media_space/init_video_upload |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/media_space/init_video_upload |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/media_space/init_video_upload |
...
| --- | --- | --- | --- | --- |
| file_md5 | string | True | 2abf0b6e5ff90ff24437a0808f171a93 | md5 of video file |
| file_size | int | True | 1261876 | size of video file, in bytes, maximum is 30MB |
