...
url: "https://open.shopee.com/documents/v2/v2.media_space.cancel_video_upload?module=91&type=1"
...
**Method:** POST
**HTTP Path:** /api/v2/media_space/cancel_video_upload
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/media_space/cancel_video_upload |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/media_space/cancel_video_upload |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/media_space/cancel_video_upload |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/media_space/cancel_video_upload |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/media_space/cancel_video_upload |
