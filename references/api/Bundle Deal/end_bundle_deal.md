...
api_name: end_bundle_deal
url: "https://open.shopee.com/documents/v2/v2.bundle_deal.end_bundle_deal?module=110&type=1"
...
**Method:** POST
**HTTP Path:** /api/v2/bundle_deal/end_bundle_deal
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/bundle_deal/end_bundle_deal |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/bundle_deal/end_bundle_deal |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/bundle_deal/end_bundle_deal |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/bundle_deal/end_bundle_deal |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/bundle_deal/end_bundle_deal |
