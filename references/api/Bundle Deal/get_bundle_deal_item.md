...
url: "https://open.shopee.com/documents/v2/v2.bundle_deal.get_bundle_deal_item?module=110&type=1"
...
**Category:** BUNDLE_DEAL
**API:** get_bundle_deal_item

**Method:** GET
**HTTP Path:** /api/v2/bundle_deal/get_bundle_deal_item
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/bundle_deal/get_bundle_deal_item |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/bundle_deal/get_bundle_deal_item |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/bundle_deal/get_bundle_deal_item |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/bundle_deal/get_bundle_deal_item |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/bundle_deal/get_bundle_deal_item |
