...
api_name: delete_bundle_deal_item
url: "https://open.shopee.com/documents/v2/v2.bundle_deal.delete_bundle_deal_item?module=110&type=1"
domain: open.shopee.com
date_saved: "2026-09-03 09:13:11"
...
**Category:** BUNDLE_DEAL
**API:** delete_bundle_deal_item

**Method:** POST
**HTTP Path:** /api/v2/bundle_deal/delete_bundle_deal_item
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/bundle_deal/delete_bundle_deal_item |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/bundle_deal/delete_bundle_deal_item |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/bundle_deal/delete_bundle_deal_item |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/bundle_deal/delete_bundle_deal_item |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/bundle_deal/delete_bundle_deal_item |
...
| --- | --- | --- | --- | --- |
| bundle_deal_id | int32 | True | 11111 | Shopee's unique identifier for a bundle deal activity. |
| item_list | object[] | True |  | The items deleted in this bundle deal promotion. |
| item_id | int32 | True | 1234 | Shopee's unique identifier for an item. |
