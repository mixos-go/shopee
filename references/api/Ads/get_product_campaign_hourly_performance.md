...
category: ads
api_name: get_product_campaign_hourly_performance
url: "https://open.shopee.com/documents/v2/v2.ads.get_product_campaign_hourly_performance?module=117&type=1"
domain: open.shopee.com
date_saved: "2026-09-03 09:13:42"
...
**Category:** ADS
**API:** get_product_campaign_hourly_performance

**Method:** GET
**HTTP Path:** /api/v2/ads/get_product_campaign_hourly_performance
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/ads/get_product_campaign_hourly_performance |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/ads/get_product_campaign_hourly_performance |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/ads/get_product_campaign_hourly_performance |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/get_product_campaign_hourly_performance |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/ads/get_product_campaign_hourly_performance |
...
HttpResponse<String> response = Unirest.get("https://partner.uat.shopeemobile.com/api/v2/ads/get_product_campaign_hourly_performance?access_token=access_token&campaign_id_list=11111%2C22222&partner_id=partner_id&performance_date=17-07-2024&shop_id=shop_id&sign=sign&timestamp=timestamp")
.asString();
```
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.uat.shopeemobile.com/api/v2/ads/get_product_campaign_hourly_performance?access_token=access_token&campaign_id_list=11111%2C22222&partner_id=partner_id&performance_date=17-07-2024&shop_id=shop_id&sign=sign&timestamp=timestamp',
