...
category: ads
api_name: edit_manual_product_ad_keywords
url: "https://open.shopee.com/documents/v2/v2.ads.edit_manual_product_ad_keywords?module=117&type=1"
...
**Category:** ADS
**API:** edit_manual_product_ad_keywords

**Method:** POST
**HTTP Path:** /api/v2/ads/edit_manual_product_ad_keywords
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/ads/edit_manual_product_ad_keywords |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/ads/edit_manual_product_ad_keywords |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/ads/edit_manual_product_ad_keywords |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/edit_manual_product_ad_keywords |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/ads/edit_manual_product_ad_keywords |
...
| campaign_id | int64 | True | 112233 | The unique identifier for a campaign |
| selected_keywords | object[] | True |  | selected keywords, required for manual bidding mode. |
| edit_action | string | True | add | The update behaviours such as "add", "delete", "restore", "change_bid_price", "change_match_type" |
| keyword | string | True | apple | bid keyword for each campaign |
| match_type | string | False | exact | exact, broad; required if changing match type |
| bid_price_per_click | float | False | 11.20 | the bid price of keyword; required if changing bid price |
...
```bash
curl --location --request POST 'https://partner.test.shopeemobile.com/api/v2/ads/edit_manual_product_ad_keywords?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp' \
--header 'Content-Type: application/json' \
--data-raw '{
   "campaign_id": 112233,
   "reference_id": "asdf-1234-qwerty",
