...
category: ads
api_name: create_auto_product_ads
url: "https://open.shopee.com/documents/v2/(coming offline soon) v2.ads.create_auto_product_ads?module=117&type=1"
...
**Category:** ADS
**API:** create_auto_product_ads

**Method:** POST
**HTTP Path:** /api/v2/ads/create_auto_product_ads
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/ads/create_auto_product_ads |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/ads/create_auto_product_ads |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/ads/create_auto_product_ads |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/create_auto_product_ads |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/ads/create_auto_product_ads |
...
```bash
curl --location --request POST 'https://partner.test.shopeemobile.com/api/v2/ads/create_auto_product_ads?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp' \
--header 'Content-Type: application/json' \
--data-raw '{
   "budget": 10.5,
   "end_date": "-",
