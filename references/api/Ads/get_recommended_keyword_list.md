...
category: ads
api_name: get_recommended_keyword_list
url: "https://open.shopee.com/documents/v2/v2.ads.get_recommended_keyword_list?module=117&type=1"
domain: open.shopee.com
date_saved: "2026-09-03 09:13:39"
...
**Category:** ADS
**API:** get_recommended_keyword_list

**Method:** GET
**HTTP Path:** /api/v2/ads/get_recommended_keyword_list
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/ads/get_recommended_keyword_list |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/ads/get_recommended_keyword_list |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/ads/get_recommended_keyword_list |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/get_recommended_keyword_list |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/ads/get_recommended_keyword_list |
...
| --- | --- | --- | --- | --- |
| item_id | int32 | True | 1111 | Shopee's unique identifier for an item. |
| input_keyword | string | False | keyword | The keyword seller typed in the manually add keyword window. |
