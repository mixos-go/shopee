...
category: ads
api_name: edit_gms_item_product_campaign
url: "https://open.shopee.com/documents/v2/v2.ads.edit_gms_item_product_campaign?module=117&type=1"
...
**Category:** ADS
**API:** edit_gms_item_product_campaign

**Method:** POST
**HTTP Path:** /api/v2/ads/edit_gms_item_product_campaign
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/ads/edit_gms_item_product_campaign |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/ads/edit_gms_item_product_campaign |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/ads/edit_gms_item_product_campaign |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/edit_gms_item_product_campaign |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/ads/edit_gms_item_product_campaign |
...
| --- | --- | --- | --- | --- |
| campaign_id | int64 | False | 325325235 | The GMS Campaign ID. Provide if available. |
| edit_action | string | True | add | The following is the list of possible actions: add remove |
| item_id_list | int64[] | True | [124312,123412,124124] | Item IDs to add / remove. Minimum 1 Item ID. Maximum 30 Item IDs. |
...
HttpResponse<String> response = Unirest.post("https://partner.shopeemobile.com/api/v2/ads/edit_gms_item_product_campaign?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.shopeemobile.com/api/v2/ads/edit_gms_item_product_campaign?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp',
...
```bash
curl --location --request POST 'https://partner.shopeemobile.com/api/v2/ads/edit_gms_item_product_campaign?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp' \
--header 'Content-Type: application/json' \
--data-raw '{
   "campaign_id": 325325235,
   "edit_action": "add",
