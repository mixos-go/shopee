...
category: ads
api_name: edit_manual_product_ads
url: "https://open.shopee.com/documents/v2/v2.ads.edit_manual_product_ads?module=117&type=1"
domain: open.shopee.com
date_saved: "2026-09-03 09:13:44"
...
**Category:** ADS
**API:** edit_manual_product_ads

**Method:** POST
**HTTP Path:** /api/v2/ads/edit_manual_product_ads
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/ads/edit_manual_product_ads |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/ads/edit_manual_product_ads |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/ads/edit_manual_product_ads |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/edit_manual_product_ads |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/ads/edit_manual_product_ads |
...
| campaign_id | int64 | True | 112234 | The unique identifier for a campaign |
| edit_action | string | True | start | Actions supported: "start", "pause", "resume", "stop", "delete", "change_budget", "change_duration", "change_smart_creative", "change_location", "change_enhanced_cpc", "change_roas_target" |
| budget | float | False | 10.50 | The budget set for the Auto Product Ads |
| start_date | string | False | 11-11-2023 | the start date per campaign. please kindly note that if you want to set unlimited date, you can just pass today's date as the start date |
...
| roas_target | float | False | 1.20 | the ROAS target for each campaign with auto bidding |
...
| status | string | True | active | active / inactive |
...
```bash
curl --location --request POST 'https://partner.test.shopeemobile.com/api/v2/ads/edit_manual_product_ads?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp' \
--header 'Content-Type: application/json' \
--data-raw '{
   "budget": 10.5,
   "campaign_id": 112234,
