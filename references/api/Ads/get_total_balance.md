...
category: ads
api_name: get_total_balance
url: "https://open.shopee.com/documents/v2/v2.ads.get_total_balance?module=117&type=1"
domain: open.shopee.com
date_saved: "2026-09-03 09:13:38"
...
**Method:** GET
**HTTP Path:** /api/v2/ads/get_total_balance
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/ads/get_total_balance |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/ads/get_total_balance |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/ads/get_total_balance |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/get_total_balance |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/ads/get_total_balance |
...
HttpResponse<String> response = Unirest.get("https://open.admin.uat.shopee.io/api/v2/ads/get_total_balance?access_token=access_token&partner_id=partner_id&shop_id=12312&sign=sign&timestamp=timestamp")
.asString();
```
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://open.admin.uat.shopee.io/api/v2/ads/get_total_balance?access_token=access_token&partner_id=partner_id&shop_id=12312&sign=sign&timestamp=timestamp',
