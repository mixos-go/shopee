...
category: ads
api_name: get_all_cpc_ads_daily_performance
url: "https://open.shopee.com/documents/v2/v2.ads.get_all_cpc_ads_daily_performance?module=117&type=1"
...
**Category:** ADS
**API:** get_all_cpc_ads_daily_performance

**Method:** GET
**HTTP Path:** /api/v2/ads/get_all_cpc_ads_daily_performance
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/ads/get_all_cpc_ads_daily_performance |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/ads/get_all_cpc_ads_daily_performance |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/ads/get_all_cpc_ads_daily_performance |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/get_all_cpc_ads_daily_performance |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/ads/get_all_cpc_ads_daily_performance |
...
| end_date | string | True | 18-03-2021 | This is the parameter to indicate the end date of the time length of performance |
