...
category: ads
api_name: get_product_level_campaign_id_list
url: "https://open.shopee.com/documents/v2/v2.ads.get_product_level_campaign_id_list?module=117&type=1"
...
**Category:** ADS
**API:** get_product_level_campaign_id_list

**Method:** GET
**HTTP Path:** /api/v2/ads/get_product_level_campaign_id_list
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/ads/get_product_level_campaign_id_list |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/ads/get_product_level_campaign_id_list |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/ads/get_product_level_campaign_id_list |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/get_product_level_campaign_id_list |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/ads/get_product_level_campaign_id_list |
...
| --- | --- | --- | --- | --- |
| ad_type | string | False | all | Any of ["","all","auto","manual"] |
| offset | int64 | False | 0 | offset |
| limit | int64 | False | 5000 | limit |
