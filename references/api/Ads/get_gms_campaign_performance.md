...
category: ads
api_name: get_gms_campaign_performance
url: "https://open.shopee.com/documents/v2/v2.ads.get_gms_campaign_performance?module=117&type=1"
domain: open.shopee.com
date_saved: "2026-09-03 09:13:47"
...
**Category:** ADS
**API:** get_gms_campaign_performance

**Method:** POST
**HTTP Path:** /api/v2/ads/get_gms_campaign_performance
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/ads/get_gms_campaign_performance |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/ads/get_gms_campaign_performance |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/ads/get_gms_campaign_performance |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/get_gms_campaign_performance |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/ads/get_gms_campaign_performance |
...
| --- | --- | --- | --- | --- |
| campaign_id | int64 | False | 13251251 | The GMS Campaign ID. Provide if available. |
...
HttpResponse<String> response = Unirest.post("https://partner.shopeemobile.com/api/v2/ads/get_gms_campaign_performance?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.shopeemobile.com/api/v2/ads/get_gms_campaign_performance?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp',
...
```bash
curl --location --request POST 'https://partner.shopeemobile.com/api/v2/ads/get_gms_campaign_performance?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp' \
--header 'Content-Type: application/json' \
--data-raw '{
   "campaign_id": 13251251,
   "end_date": "11-11-2025",
