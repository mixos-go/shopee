...
category: ads
api_name: get_ads_fácil_shop_rate
url: "https://open.shopee.com/documents/v2/v2.ads.get_ads_fácil_shop_rate?module=117&type=1"
...
**Category:** ADS
**API:** get_ads_fácil_shop_rate

**Method:** GET
**HTTP Path:** /api/v2/ads/get_ads_facil_shop_rate
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/ads/get_ads_facil_shop_rate |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/ads/get_ads_facil_shop_rate |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/ads/get_ads_facil_shop_rate |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/get_ads_facil_shop_rate |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/ads/get_ads_facil_shop_rate |
