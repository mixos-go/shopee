...
category: ads
api_name: get_shop_toggle_info
url: "https://open.shopee.com/documents/v2/v2.ads.get_shop_toggle_info?module=117&type=1"
...
**Category:** ADS
**API:** get_shop_toggle_info

**Method:** GET
**HTTP Path:** /api/v2/ads/get_shop_toggle_info
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/ads/get_shop_toggle_info |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/ads/get_shop_toggle_info |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/ads/get_shop_toggle_info |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/ads/get_shop_toggle_info |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/ads/get_shop_toggle_info |
