...
category: returns
api_name: upload_proof
url: "https://open.shopee.com/documents/v2/v2.returns.upload_proof?module=102&type=1"
domain: open.shopee.com
date_saved: "2026-09-03 09:13:33"
...
**Method:** POST
**HTTP Path:** /api/v2/returns/upload_proof
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/returns/upload_proof |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/returns/upload_proof |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/returns/upload_proof |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/returns/upload_proof |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/returns/upload_proof |
...
| --- | --- | --- | --- | --- |
| return_sn | string | True | 211019111701669 | The serial number of return. |
| photo | object[] | False |  |  |
| url | string | True | https://file-proxy.seller.test.shopee.com/api/v2/files/c2hvcGVlLWRyYzAx/6cd5662c25964655827057bb2bfa69e2.png | Uploaded proof image link, it is recommended to pass in the return url of api called convert_image. |
| thumbnail | string | True | https://file-proxy.seller.test.shopee.com/api/v2/files/c2hvcGVlLWRyYzAx/6cd5662c25964655827057bb2bfa69e2.png | The proof image thumbnail. |
| description | string | False | test | text description in the dispute proof |
...
```bash
curl --location --request POST 'https://partner.shopeemobile.com/api/v2/returns/upload_proof?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp' \
--header 'Content-Type: application/json' \
--data-raw '{
   "description": "test",
   "photo": [
