...
category: returns
api_name: convert_image
url: "https://open.shopee.com/documents/v2/v2.returns.convert_image?module=102&type=1"
...
**Method:** POST
**HTTP Path:** /api/v2/returns/convert_image
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/returns/convert_image |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/returns/convert_image |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/returns/convert_image |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/returns/convert_image |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/returns/convert_image |
...
| --- | --- | --- | --- | --- |
| return_sn | string | True | 220707155172370 | The serial number of return. |
| upload_image | file | True |  | The proof picture to be uploaded must be within 10MB in size, and the format only supports .jpg, .jpeg, and .png. Only one picture is allowed to be uploaded per request. If multiple pictures are uploaded, only the first picture will be processed. |
...
```bash
curl --location --request POST 'https://partner.shopeemobile.com/api/v2/returns/convert_image?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp' \
