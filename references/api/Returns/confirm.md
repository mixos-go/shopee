...
category: returns
api_name: confirm
url: "https://open.shopee.com/documents/v2/v2.returns.confirm?module=102&type=1"
...
**Method:** POST
**HTTP Path:** /api/v2/returns/confirm
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/returns/confirm |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/returns/confirm |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/returns/confirm |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/returns/confirm |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/returns/confirm |
...
| --- | --- | --- | --- | --- |
| return_sn | string | True | 200203171852695 | The serial number of return. |
...
```bash
curl --location --request POST 'https://partner.shopeemobile.com/api/v2/returns/confirm?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp' \
--header 'Content-Type: application/json' \
--data-raw '{
   "return_sn": "200203171852695"
}'
