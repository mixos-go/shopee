...
category: returns
api_name: offer
url: "https://open.shopee.com/documents/v2/v2.returns.offer?module=102&type=1"
...
**Method:** POST
**HTTP Path:** /api/v2/returns/offer
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/returns/offer |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/returns/offer |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/returns/offer |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/returns/offer |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/returns/offer |
...
| proposed_solution | string | True | RETURN_REFUND | The new solution to be offered. See "Data Definition - ReturnSolution" |
| proposed_adjusted_refund_amount | float | False | 100.0 | The new refund amount to be offered |
...
```bash
curl --location --request POST 'https://partner.shopeemobile.com/api/v2/returns/offer?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp' \
--header 'Content-Type: application/json' \
--data-raw '{
   "proposed_adjusted_refund_amount": 100,
   "proposed_solution": "RETURN_REFUND",
