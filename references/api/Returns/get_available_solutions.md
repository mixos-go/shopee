...
category: returns
api_name: get_available_solutions
url: "https://open.shopee.com/documents/v2/v2.returns.get_available_solutions?module=102&type=1"
...
**Category:** RETURNS
**API:** get_available_solutions

**Method:** GET
**HTTP Path:** /api/v2/returns/get_available_solutions
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/returns/get_available_solutions |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/returns/get_available_solutions |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/returns/get_available_solutions |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/returns/get_available_solutions |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/returns/get_available_solutions |
...
| --- | --- | --- | --- | --- |
| return_sn | string | True | 220106202649696 | The serial number of return. |
