...
category: first_mile
api_name: generate_and_bind_first_mile_tracking_number
url: "https://open.shopee.com/documents/v2/v2.first_mile.generate_and_bind_first_mile_tracking_number?module=96&type=1"
...
**Category:** FIRST_MILE
**API:** generate_and_bind_first_mile_tracking_number

**Method:** POST
**HTTP Path:** /api/v2/first_mile/generate_and_bind_first_mile_tracking_number
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/first_mile/generate_and_bind_first_mile_tracking_number |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/first_mile/generate_and_bind_first_mile_tracking_number |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/first_mile/generate_and_bind_first_mile_tracking_number |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/first_mile/generate_and_bind_first_mile_tracking_number |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/first_mile/generate_and_bind_first_mile_tracking_number |
...
HttpResponse<String> response = Unirest.post("https://partner.shopeemobile.com/api/v2/first_mile/generate_and_bind_first_mile_tracking_number?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.shopeemobile.com/api/v2/first_mile/generate_and_bind_first_mile_tracking_number?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp',
...
```bash
curl --location --request POST 'https://partner.shopeemobile.com/api/v2/first_mile/generate_and_bind_first_mile_tracking_number?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp' \
--header 'Content-Type: application/json' \
--data-raw '{
   "courier_delivery_info": {
      "address_id": 11222,
