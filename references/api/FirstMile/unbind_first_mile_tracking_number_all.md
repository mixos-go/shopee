...
category: first_mile
api_name: unbind_first_mile_tracking_number_all
url: "https://open.shopee.com/documents/v2/v2.first_mile.unbind_first_mile_tracking_number_all?module=96&type=1"
...
**Category:** FIRST_MILE
**API:** unbind_first_mile_tracking_number_all

**Method:** POST
**HTTP Path:** /api/v2/first_mile/unbind_first_mile_tracking_number_all
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/first_mile/unbind_first_mile_tracking_number_all |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/first_mile/unbind_first_mile_tracking_number_all |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/first_mile/unbind_first_mile_tracking_number_all |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/first_mile/unbind_first_mile_tracking_number_all |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/first_mile/unbind_first_mile_tracking_number_all |
...
| --- | --- | --- | --- | --- |
| order_list | object[] | True |  | The list of order info you want to unbind from the first mile tracking number or binding ID. You can specify up to 50 order_sns in this call. |
| order_sn | string | True | 2410215AMTPJ2N | Shopee's unique identifier for an order. |
| package_number | string | False | OFG183183235200317 | Shopee's unique identifier for the package under an order. You should fill the field with empty string when there isn't a package number. |
...
HttpResponse<String> response = Unirest.post("https://partner.shopeemobile.com/api/v2/first_mile/unbind_first_mile_tracking_number_all?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.shopeemobile.com/api/v2/first_mile/unbind_first_mile_tracking_number_all?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp',
...
```bash
curl --location --request POST 'https://partner.shopeemobile.com/api/v2/first_mile/unbind_first_mile_tracking_number_all?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp' \
--header 'Content-Type: application/json' \
--data-raw '{
   "order_list": [
      {
