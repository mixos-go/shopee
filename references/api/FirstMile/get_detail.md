...
category: first_mile
api_name: get_detail
url: "https://open.shopee.com/documents/v2/v2.first_mile.get_detail?module=96&type=1"
...
**Method:** GET
**HTTP Path:** /api/v2/first_mile/get_detail
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/first_mile/get_detail |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/first_mile/get_detail |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/first_mile/get_detail |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/first_mile/get_detail |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/first_mile/get_detail |
...
| --- | --- | --- | --- | --- |
| first_mile_tracking_number | string | True | CNF731738838434210105 | The first mile tracking number. |
