...
url: "https://open.shopee.com/documents/v2/v2.first_mile.get_waybill?module=96&type=1"
...
**Method:** POST
**HTTP Path:** /api/v2/first_mile/get_waybill
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/first_mile/get_waybill |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/first_mile/get_waybill |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/first_mile/get_waybill |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/first_mile/get_waybill |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/first_mile/get_waybill |
...
| --- | --- | --- | --- | --- |
| first_mile_tracking_number_list | string[] | True | ["CNF880344919515201212"] | The first mile tracking number that you want to print waybill.limit [1, 50] |
