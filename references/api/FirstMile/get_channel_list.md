...
url: "https://open.shopee.com/documents/v2/v2.first_mile.get_channel_list?module=96&type=1"
...
**Method:** GET
**HTTP Path:** /api/v2/first_mile/get_channel_list
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/first_mile/get_channel_list |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/first_mile/get_channel_list |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/first_mile/get_channel_list |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/first_mile/get_channel_list |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/first_mile/get_channel_list |
...
| --- | --- | --- | --- | --- |
| region | string | False | CN | Use this field to specify the region you want to ship parcel. Available value: CN, KR |
