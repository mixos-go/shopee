...
category: first_mile
api_name: generate_first_mile_tracking_number
url: "https://open.shopee.com/documents/v2/v2.first_mile.generate_first_mile_tracking_number?module=96&type=1"
domain: open.shopee.com
date_saved: "2026-09-03 09:12:50"
...
**Category:** FIRST_MILE
**API:** generate_first_mile_tracking_number

**Method:** POST
**HTTP Path:** /api/v2/first_mile/generate_first_mile_tracking_number
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/first_mile/generate_first_mile_tracking_number |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/first_mile/generate_first_mile_tracking_number |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/first_mile/generate_first_mile_tracking_number |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/first_mile/generate_first_mile_tracking_number |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/first_mile/generate_first_mile_tracking_number |
...
| --- | --- | --- | --- | --- |
| declare_date | string | True | 2020-12-20 | This field is used for seller to specify the declare time. |
| quantity | int | False | 1 | The number of first-mile tracking numbers generated. Up to 20 first-mile tracking numbers can be generated for one declaration day. |
