...
url: "https://open.shopee.com/documents/v2/v2.shop.get_profile?module=92&type=1"
...
**Method:** GET
**HTTP Path:** /api/v2/shop/get_profile
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/shop/get_profile |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/shop/get_profile |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/shop/get_profile |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/shop/get_profile |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/shop/get_profile |
