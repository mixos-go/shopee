...
category: shop
api_name: get_authorised_reseller_brand
url: "https://open.shopee.com/documents/v2/v2.shop.get_authorised_reseller_brand?module=92&type=1"
...
**Category:** SHOP
**API:** get_authorised_reseller_brand

**Method:** GET
**HTTP Path:** /api/v2/shop/get_authorised_reseller_brand
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/shop/get_authorised_reseller_brand |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/shop/get_authorised_reseller_brand |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/shop/get_authorised_reseller_brand |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/shop/get_authorised_reseller_brand |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/shop/get_authorised_reseller_brand |
