...
api_name: update_shop_category
url: "https://open.shopee.com/documents/v2/v2.shop_category.update_shop_category?module=101&type=1"
...
**Category:** SHOP_CATEGORY
**API:** update_shop_category

**Method:** POST
**HTTP Path:** /api/v2/shop_category/update_shop_category
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/shop_category/update_shop_category |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/shop_category/update_shop_category |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/shop_category/update_shop_category |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/shop_category/update_shop_category |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/shop_category/update_shop_category |
...
| name | string | False | OA_V2_11 | ShopCategory's name. |
| sort_weight | int | False | 21 | ShopCategory's sort weight. |
| status | string | False | NORMAL | ShopCategory's status. Applicable values: NORMAL, INACTIVE, DELETED. |
