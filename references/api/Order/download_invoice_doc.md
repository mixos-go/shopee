...
category: order
api_name: download_invoice_doc
url: "https://open.shopee.com/documents/v2/v2.order.download_invoice_doc?module=94&type=1"
...
**Category:** ORDER
**API:** download_invoice_doc

**Method:** GET
**HTTP Path:** /api/v2/order/download_invoice_doc
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/order/download_invoice_doc |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/order/download_invoice_doc |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/order/download_invoice_doc |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/order/download_invoice_doc |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/order/download_invoice_doc |
