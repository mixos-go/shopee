...
category: order
api_name: get_booking_list
url: "https://open.shopee.com/documents/v2/v2.order.get_booking_list?module=94&type=1"
...
**Category:** ORDER
**API:** get_booking_list

**Method:** GET
**HTTP Path:** /api/v2/order/get_booking_list
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/order/get_booking_list |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/order/get_booking_list |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/order/get_booking_list |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/order/get_booking_list |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/order/get_booking_list |
...
| time_from | int64 | True | 1607235072 | The time_from and time_to fields specify a date range for retrieving bookings (based on the time_range_field). The time_from field is the starting date range. The maximum date range that may be specified with the time_from and time_to fields is 15 days. |
| time_to | int64 | True | 1608271872 | The time_from and time_to fields specify a date range for retrieving bookings (based on the time_range_field). The time_from field is the starting date range. The maximum date range that may be specified with the time_from and time_to fields is 15 days. |
...
| booking_status | string | False | READY_TO_SHIP | The booking_status filter for retrieving bookings and each one only every request. Available value: READY_TO_SHIP/PROCESSED/SHIPPED/CANCELLED/MATCHED |
