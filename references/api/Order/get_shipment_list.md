...
url: "https://open.shopee.com/documents/v2/v2.order.get_shipment_list?module=94&type=1"
...
**Category:** ORDER
**API:** get_shipment_list

**Method:** GET
**HTTP Path:** /api/v2/order/get_shipment_list
...
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/order/get_shipment_list |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/order/get_shipment_list |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/order/get_shipment_list |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/order/get_shipment_list |
