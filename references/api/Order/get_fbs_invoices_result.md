...
category: order
api_name: get_fbs_invoices_result
url: "https://open.shopee.com/documents/v2/v2.order.get_fbs_invoices_result?module=94&type=1"
...
**Category:** ORDER
**API:** get_fbs_invoices_result

**Method:** POST
**HTTP Path:** /api/v2/order/get_fbs_invoices_result
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/order/get_fbs_invoices_result |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/order/get_fbs_invoices_result |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/order/get_fbs_invoices_result |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/order/get_fbs_invoices_result |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/order/get_fbs_invoices_result |
...
| --- | --- | --- | --- | --- |
| request_id_list | object | True |  | - |
| request_id | int64[] | True | [123,234,456] | A list of integers representing the request IDs to be queried. |
