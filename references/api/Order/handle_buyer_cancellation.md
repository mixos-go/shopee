...
category: order
api_name: handle_buyer_cancellation
url: "https://open.shopee.com/documents/v2/v2.order.handle_buyer_cancellation?module=94&type=1"
...
**Category:** ORDER
**API:** handle_buyer_cancellation

**Method:** POST
**HTTP Path:** /api/v2/order/handle_buyer_cancellation
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/order/handle_buyer_cancellation |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/order/handle_buyer_cancellation |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/order/handle_buyer_cancellation |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/order/handle_buyer_cancellation |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/order/handle_buyer_cancellation |
...
| --- | --- | --- | --- | --- |
| order_sn | string | True | 201016F6B94MQK | Shopee's unique identifier for an order. |
| operation | string | True | ACCEPT | The operation you want to handle.Avaiable value: ACCEPT, REJECT |
...
```bash
curl --location --request POST 'https://partner.shopeemobile.com/api/v2/order/handle_buyer_cancellation?partner_id=partner_id&sign=sign&access_token=access_token&timestamp=timestamp&shop_id=shop_id' \
--header 'Content-Type: application/json' \
--data-raw '{
   "operation": "ACCEPT",
   "order_sn": "201016F6B94MQK"
