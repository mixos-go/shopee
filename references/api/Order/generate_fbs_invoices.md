...
category: order
api_name: generate_fbs_invoices
url: "https://open.shopee.com/documents/v2/v2.order.generate_fbs_invoices?module=94&type=1"
...
**Category:** ORDER
**API:** generate_fbs_invoices

**Method:** POST
**HTTP Path:** /api/v2/order/generate_fbs_invoices
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/order/generate_fbs_invoices |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/order/generate_fbs_invoices |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/order/generate_fbs_invoices |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/order/generate_fbs_invoices |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/order/generate_fbs_invoices |
