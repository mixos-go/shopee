...
url: "https://open.shopee.com/documents/v2/v2.media.complete_video_upload?module=130&type=1"
...
**Method:** POST
**HTTP Path:** /api/v2/media/complete_video_upload
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/media/complete_video_upload |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/media/complete_video_upload |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/media/complete_video_upload |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/media/complete_video_upload |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/media/complete_video_upload |
...
HttpResponse<String> response = Unirest.post("https://partner.shopeemobile.com/api/v2/media/complete_video_upload?partner_id=partner_id&sign=sign&timestamp=timestamp")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.shopeemobile.com/api/v2/media/complete_video_upload?partner_id=partner_id&sign=sign&timestamp=timestamp',
...
```bash
curl --location --request POST 'https://partner.shopeemobile.com/api/v2/media/complete_video_upload?partner_id=partner_id&sign=sign&timestamp=timestamp' \
--header 'Content-Type: application/json' \
--data-raw '{
   "video_upload_id": "sg-11110201-6kh48-mepm7a0ttcw3c3"
}'
