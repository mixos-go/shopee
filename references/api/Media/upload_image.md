...
url: "https://open.shopee.com/documents/v2/v2.media.upload_image?module=130&type=1"
...
**Method:** POST
**HTTP Path:** /api/v2/media/upload_image
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/media/upload_image |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/media/upload_image |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/media/upload_image |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/media/upload_image |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/media/upload_image |
...
| --- | --- | --- | --- | --- |
| business | int32 | True | 2 | Defines the business type of the uploaded image. Supported values: 2 = Returns |
| scene | int32 | True | 1 | Defines the purpose of the uploaded image under the specified business type. Supported values: - If business = 2 (Returns): 1 = Return Seller Self Arrange Pickup Proof Image |
| images | file | True |  | The image files to be uploaded. Rules and restrictions by business and scene: - If business = 2 (Returns) and scene = 1 (Return Seller Self Arrange Pickup Proof Image): Up to 3 images can be uploaded. Each image must not exceed 10MB . Supported formats: JPG, JPEG, PNG . |
...
HttpResponse<String> response = Unirest.post("https://partner.shopeemobile.com/api/v2/media/upload_image?partner_id=partner_id&sign=sign&timestamp=timestamp")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.shopeemobile.com/api/v2/media/upload_image?partner_id=partner_id&sign=sign&timestamp=timestamp',
  ...
  CURLOPT_POSTFIELDS => array('images'=> new CURLFILE('/path/to/file') /* Replace with actual file path */),
...
```bash
curl --location --request POST 'https://partner.shopeemobile.com/api/v2/media/upload_image?partner_id=partner_id&sign=sign&timestamp=timestamp' \
--form 'images=@"/path/to/file"'  #replace the sample path with your file path
```
