...
category: fbs
api_name: query_br_shop_enrollment_status
url: "https://open.shopee.com/documents/v2/v2.fbs.query_br_shop_enrollment_status?module=126&type=1"
...
**Category:** FBS
**API:** query_br_shop_enrollment_status

**Method:** GET
**HTTP Path:** /api/v2/fbs/query_br_shop_enrollment_status
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/fbs/query_br_shop_enrollment_status |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/fbs/query_br_shop_enrollment_status |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/fbs/query_br_shop_enrollment_status |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/fbs/query_br_shop_enrollment_status |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/fbs/query_br_shop_enrollment_status |
...
| enrollment_status | int32 | 1 | 1: enable enrollment 2: disable enrollment 3: already enrollment |
