...
category: fbs
api_name: query_br_sku_block_status
url: "https://open.shopee.com/documents/v2/v2.fbs.query_br_sku_block_status?module=126&type=1"
...
**Category:** FBS
**API:** query_br_sku_block_status

**Method:** GET
**HTTP Path:** /api/v2/fbs/query_br_sku_block_status
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/fbs/query_br_sku_block_status |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/fbs/query_br_sku_block_status |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/fbs/query_br_sku_block_status |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/fbs/query_br_sku_block_status |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/fbs/query_br_sku_block_status |
...
| --- | --- | --- | --- | --- |
| shop_sku_id | string | True | 123_234 |  |
