...
category: logistics
api_name: download_shipping_document_job
url: "https://open.shopee.com/documents/v2/v2.logistics.download_shipping_document_job?module=95&type=1"
...
**Category:** LOGISTICS
**API:** download_shipping_document_job

**Method:** POST
**HTTP Path:** /api/v2/logistics/download_shipping_document_job
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/logistics/download_shipping_document_job |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/logistics/download_shipping_document_job |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/logistics/download_shipping_document_job |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/logistics/download_shipping_document_job |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/logistics/download_shipping_document_job |
...
| --- | --- | --- | --- | --- |
| job_id | string | True | SDK0001_a86148a97a6e04ce2ed468968de344b7 | Generated Job ID for status tracking and download the Shipping Document |
...
HttpResponse<String> response = Unirest.post("https://partner.shopeemobile.com/api/v2/logistics/download_shipping_document_job?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.shopeemobile.com/api/v2/logistics/download_shipping_document_job?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp',
...
```bash
curl --location --request POST 'https://partner.shopeemobile.com/api/v2/logistics/download_shipping_document_job?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp' \
--header 'Content-Type: application/json' \
--data-raw '{
   "job_id": "SDK0001_a86148a97a6e04ce2ed468968de344b7"
}'
