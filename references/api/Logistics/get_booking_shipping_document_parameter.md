...
category: logistics
api_name: get_booking_shipping_document_parameter
url: "https://open.shopee.com/documents/v2/v2.logistics.get_booking_shipping_document_parameter?module=95&type=1"
domain: open.shopee.com
date_saved: "2026-09-03 09:12:43"
...
**Category:** LOGISTICS
**API:** get_booking_shipping_document_parameter

**Method:** POST
**HTTP Path:** /api/v2/logistics/get_booking_shipping_document_parameter
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/logistics/get_booking_shipping_document_parameter |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/logistics/get_booking_shipping_document_parameter |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/logistics/get_booking_shipping_document_parameter |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/logistics/get_booking_shipping_document_parameter |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/logistics/get_booking_shipping_document_parameter |
...
HttpResponse<String> response = Unirest.post("https://open.admin.uat.shopee.io/api/v2/logistics/get_booking_shipping_document_parameter?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://open.admin.uat.shopee.io/api/v2/logistics/get_booking_shipping_document_parameter?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp',
...
```bash
curl --location --request POST 'https://open.admin.uat.shopee.io/api/v2/logistics/get_booking_shipping_document_parameter?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp' \
--header 'Content-Type: application/json' \
--data-raw '{
   "booking_list": [
      {
