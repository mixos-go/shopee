...
category: logistics
api_name: set_mart_packaging_info
url: "https://open.shopee.com/documents/v2/v2.logistics.set_mart_packaging_info?module=95&type=1"
...
**Category:** LOGISTICS
**API:** set_mart_packaging_info

**Method:** POST
**HTTP Path:** /api/v2/logistics/set_mart_packaging_info
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/logistics/set_mart_packaging_info |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/logistics/set_mart_packaging_info |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/logistics/set_mart_packaging_info |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/logistics/set_mart_packaging_info |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/logistics/set_mart_packaging_info |
...
| --- | --- | --- | --- | --- |
| enable | boolean | True | true | Indicates whether the seller has enabled or disabled the packaging fee configuration. True: The seller charges a packaging fee. False: The seller does not charge a packaging fee. |
| dimension | object | False |  | Required if enabled is set to True. |
| length | int32 | True | 15 | The length of the packaging in centimetres (cm). |
| width | int32 | True | 15 | The width of the packaging in centimetres (cm). |
| height | int32 | True | 15 | The height of the packaging in centimetres (cm). |
| packaging_fee | object | False |  | Required if enabled is set to True. |
| value | float | True | 100.00 | The packaging fee price in your region's local currency. For SG/MY/BR/MX seller: Sellers can set the price with two decimal place, other regions can only set the price as an integer. |
...
HttpResponse<String> response = Unirest.post("https://partner.shopeemobile.com/api/v2/logistics/set_mart_packaging_info?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.shopeemobile.com/api/v2/logistics/set_mart_packaging_info?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp',
...
```bash
curl --location --request POST 'https://partner.shopeemobile.com/api/v2/logistics/set_mart_packaging_info?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp' \
--header 'Content-Type: application/json' \
--data-raw '{
   "dimension": {
      "height": 15,
