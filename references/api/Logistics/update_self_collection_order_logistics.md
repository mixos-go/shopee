...
category: logistics
api_name: update_self_collection_order_logistics
url: "https://open.shopee.com/documents/v2/v2.logistics.update_self_collection_order_logistics?module=95&type=1"
domain: open.shopee.com
date_saved: "2026-09-03 09:12:47"
...
**Category:** LOGISTICS
**API:** update_self_collection_order_logistics

**Method:** POST
**HTTP Path:** /api/v2/logistics/update_self_collection_order_logistics
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/logistics/update_self_collection_order_logistics |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/logistics/update_self_collection_order_logistics |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/logistics/update_self_collection_order_logistics |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/logistics/update_self_collection_order_logistics |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/logistics/update_self_collection_order_logistics |
...
| --- | --- | --- | --- | --- |
| package_number | string | True | OFG211171863281841 | Shopee's unique identifier for the package under an order. |
| self_collection_logistics_action | string | True | order_collected | Order logistics action. available values: - ready_for_collection - order_collected |
| epoc_image_list | string[] | False | ["id-11134284-7r98o-mef6xcoiw1nt15"] | List of image_id for the proof that buyer already collected the order at the store. Required when self_collection_logistics_action is order_collected. Max: 3. You can call the v2.media.upload_image to upload image and get the image_id, for this scenario, please pass the business = 1 and scene = 1. |
| pin | string | False | 123456 | PIN code required for prescription orders when buyer collects at your shop. |
...
```bash
curl --location --request POST 'https://partner.shopeemobile.com/api/v2/logistics/update_self_collection_order_logistics?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp' \
--header 'Content-Type: application/json' \
--data-raw '{
   "epoc_image_list": [
      "id-11134284-7r98o-mef6xcoiw1nt15"
...
| Date | Update Details |
| --- | --- |
| 2026-03-27 | Add new pin request parameter |
| 2025-09-18 | New API |
