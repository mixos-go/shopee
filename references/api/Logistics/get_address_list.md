...
url: "https://open.shopee.com/documents/v2/v2.logistics.get_address_list?module=95&type=1"
...
**Method:** GET
**HTTP Path:** /api/v2/logistics/get_address_list
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/logistics/get_address_list |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/logistics/get_address_list |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/logistics/get_address_list |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/logistics/get_address_list |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/logistics/get_address_list |
...
| address_type | string[] | ["DEFAULT_ADDRESS","PICK_UP_ADDRESS"] | The flag of shop address.Available values: DEFAULT_ADDRESS, PICK_UP_ADDRESS, RETURN_ADDRESS, INBOUND_PICKUP_ADDRESS. |
