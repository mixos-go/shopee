...
category: logistics
api_name: get_mass_tracking_number
url: "https://open.shopee.com/documents/v2/v2.logistics.get_mass_tracking_number?module=95&type=1"
...
**Category:** LOGISTICS
**API:** get_mass_tracking_number

**Method:** POST
**HTTP Path:** /api/v2/logistics/get_mass_tracking_number
...
| package_number | string | True |  | Shopee's unique identifier for the package under an order. You should't fill the field with empty string when there isn't a package number. |
