...
category: logistics
api_name: get_booking_tracking_number
url: "https://open.shopee.com/documents/v2/v2.logistics.get_booking_tracking_number?module=95&type=1"
...
**Category:** LOGISTICS
**API:** get_booking_tracking_number

**Method:** GET
**HTTP Path:** /api/v2/logistics/get_booking_tracking_number
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/logistics/get_booking_tracking_number |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/logistics/get_booking_tracking_number |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/logistics/get_booking_tracking_number |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/logistics/get_booking_tracking_number |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/logistics/get_booking_tracking_number |
