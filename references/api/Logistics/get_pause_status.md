...
category: logistics
api_name: get_pause_status
url: "https://open.shopee.com/documents/v2/v2.logistics.get_pause_status?module=95&type=1"
...
**Method:** GET
**HTTP Path:** /api/v2/logistics/get_pause_status
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/logistics/get_pause_status |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/logistics/get_pause_status |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/logistics/get_pause_status |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/logistics/get_pause_status |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/logistics/get_pause_status |
...
HttpResponse<String> response = Unirest.get("https://partner.shopeemobile.com/api/v2/logistics/get_pause_status?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp")
.asString();
```
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.shopeemobile.com/api/v2/logistics/get_pause_status?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp',
...
```bash
curl --location --request GET 'https://partner.shopeemobile.com/api/v2/logistics/get_pause_status?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp'
```
...
```python
import requests
url = "https://partner.shopeemobile.com/api/v2/logistics/get_pause_status?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp"
payload={}
headers = {
}
