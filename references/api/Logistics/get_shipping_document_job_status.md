...
category: logistics
api_name: get_shipping_document_job_status
url: "https://open.shopee.com/documents/v2/v2.logistics.get_shipping_document_job_status?module=95&type=1"
...
**Category:** LOGISTICS
**API:** get_shipping_document_job_status

**Method:** POST
**HTTP Path:** /api/v2/logistics/get_shipping_document_job_status
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/logistics/get_shipping_document_job_status |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/logistics/get_shipping_document_job_status |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/logistics/get_shipping_document_job_status |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/logistics/get_shipping_document_job_status |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/logistics/get_shipping_document_job_status |
...
HttpResponse<String> response = Unirest.post("https://partner.shopeemobile.com/api/v2/logistics/get_shipping_document_job_status?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.shopeemobile.com/api/v2/logistics/get_shipping_document_job_status?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp',
...
```bash
curl --location --request POST 'https://partner.shopeemobile.com/api/v2/logistics/get_shipping_document_job_status?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp' \
--header 'Content-Type: application/json' \
--data-raw '{
   "job_id": "SDK0001_a86148a97a6e04ce2ed468968de344b7"
}'
