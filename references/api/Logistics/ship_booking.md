...
category: logistics
api_name: ship_booking
url: "https://open.shopee.com/documents/v2/v2.logistics.ship_booking?module=95&type=1"
...
**Method:** POST
**HTTP Path:** /api/v2/logistics/ship_booking
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/logistics/ship_booking |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/logistics/ship_booking |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/logistics/ship_booking |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/logistics/ship_booking |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/logistics/ship_booking |
...
| address_id | int64 | True |  | The identity of address. Retrieved from v2.logistics.get_booking_shipping_parameter. |
| pickup_time_id | string | False |  | The pickup time id. Retrieved from v2.logistics.get_shipping_booking_parameter, you can only select one from the time_slot_list. Some logistics channels may not return any date or time for pickup time slots. In such cases, sellers can arrange shipment without selecting any time slot, and Shopee will arrange a suitable timing for these situations. |
...
```bash
curl --location --request POST 'https://open.admin.uat.shopee.io/api/v2/logistics/ship_booking?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp' \
--header 'Content-Type: application/json' \
--data-raw '{
   "booking_sn": "201214JASXYXY6",
   "dropoff": {},
