...
category: logistics
api_name: download_booking_shipping_document
url: "https://open.shopee.com/documents/v2/v2.logistics.download_booking_shipping_document?module=95&type=1"
...
**Category:** LOGISTICS
**API:** download_booking_shipping_document

**Method:** POST
**HTTP Path:** /api/v2/logistics/download_booking_shipping_document
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/logistics/download_booking_shipping_document |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/logistics/download_booking_shipping_document |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/logistics/download_booking_shipping_document |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/logistics/download_booking_shipping_document |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/logistics/download_booking_shipping_document |
...
```bash
curl --location --request POST 'https://open.admin.uat.shopee.io/api/v2/logistics/download_booking_shipping_document?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp' \
--header 'Content-Type: application/json' \
--data-raw '{
   "booking_list": [
      {
