...
category: logistics
api_name: download_to_label
url: "https://open.shopee.com/documents/v2/v2.logistics.download_to_label?module=95&type=1"
...
**Category:** LOGISTICS
**API:** download_to_label

**Method:** POST
**HTTP Path:** /api/v2/logistics/download_to_label
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/logistics/download_to_label |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/logistics/download_to_label |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/logistics/download_to_label |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/logistics/download_to_label |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/logistics/download_to_label |
...
| --- | --- | --- | --- | --- |
| sorting_group | int32 | True | 1 | Sorting Group of the TO. Available value: 1:North 2:South |
| quantity | int32 | False | 1 | Specifies the TO quantity, up to a maximum of 20 per request. If not specified, the default value is 1 |
...
HttpResponse<String> response = Unirest.post("https://partner.shopeemobile.com/api/v2/logistics/download_to_label?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.shopeemobile.com/api/v2/logistics/download_to_label?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp',
...
```bash
curl --location --request POST 'https://partner.shopeemobile.com/api/v2/logistics/download_to_label?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp' \
--header 'Content-Type: application/json' \
--data-raw '{
   "quantity": 1,
   "sorting_group": 1
