...
url: "https://open.shopee.com/documents/v2/v2.logistics.get_tracking_number?module=95&type=1"
...
**Category:** LOGISTICS
**API:** get_tracking_number

**Method:** GET
**HTTP Path:** /api/v2/logistics/get_tracking_number
