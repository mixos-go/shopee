...
category: logistics
api_name: delete_special_operating_hour
url: "https://open.shopee.com/documents/v2/v2.logistics.delete_special_operating_hour?module=95&type=1"
...
**Category:** LOGISTICS
**API:** delete_special_operating_hour

**Method:** POST
**HTTP Path:** /api/v2/logistics/delete_special_operating_hour
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/logistics/delete_special_operating_hour |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/logistics/delete_special_operating_hour |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/logistics/delete_special_operating_hour |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/logistics/delete_special_operating_hour |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/logistics/delete_special_operating_hour |
...
| --- | --- | --- | --- | --- |
| name | string | True | 3.3 Campaign | Name of the special operating hour which can be retrieved from v2.logistics.get_operating_hours |
...
```bash
curl --location --request POST 'https://partner.shopeemobile.com/api/v2/logistics/delete_special_operating_hour?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp' \
--header 'Content-Type: application/json' \
--data-raw '{
   "name": "3.3 Campaign"
}'
