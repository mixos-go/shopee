...
category: logistics
api_name: get_mart_packaging_info
url: "https://open.shopee.com/documents/v2/v2.logistics.get_mart_packaging_info?module=95&type=1"
...
**Category:** LOGISTICS
**API:** get_mart_packaging_info

**Method:** GET
**HTTP Path:** /api/v2/logistics/get_mart_packaging_info
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/logistics/get_mart_packaging_info |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/logistics/get_mart_packaging_info |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/logistics/get_mart_packaging_info |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/logistics/get_mart_packaging_info |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/logistics/get_mart_packaging_info |
