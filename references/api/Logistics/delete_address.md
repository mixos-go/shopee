...
url: "https://open.shopee.com/documents/v2/v2.logistics.delete_address?module=95&type=1"
...
**Method:** POST
**HTTP Path:** /api/v2/logistics/delete_address
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/logistics/delete_address |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/logistics/delete_address |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/logistics/delete_address |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/logistics/delete_address |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/logistics/delete_address |
...
| --- | --- | --- | --- | --- |
| address_id | int | True | 14278 | The identity of address you want to delete. |
