...
category: public
api_name: get_shopee_ip_ranges
url: "https://open.shopee.com/documents/v2/v2.public.get_shopee_ip_ranges?module=104&type=1"
...
**Category:** PUBLIC
**API:** get_shopee_ip_ranges

**Method:** GET
**HTTP Path:** /api/v2/public/get_shopee_ip_ranges
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/public/get_shopee_ip_ranges |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/public/get_shopee_ip_ranges |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/public/get_shopee_ip_ranges |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/public/get_shopee_ip_ranges |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/public/get_shopee_ip_ranges |
