...
category: top_picks
api_name: delete_top_picks
url: "https://open.shopee.com/documents/v2/v2.top_picks.delete_top_picks?module=100&type=1"
...
**Category:** TOP_PICKS
**API:** delete_top_picks

**Method:** POST
**HTTP Path:** /api/v2/top_picks/delete_top_picks
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/top_picks/delete_top_picks |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/top_picks/delete_top_picks |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/top_picks/delete_top_picks |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/top_picks/delete_top_picks |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/top_picks/delete_top_picks |
