...
category: top_picks
api_name: get_top_picks_list
url: "https://open.shopee.com/documents/v2/v2.top_picks.get_top_picks_list?module=100&type=1"
...
**Category:** TOP_PICKS
**API:** get_top_picks_list

**Method:** GET
**HTTP Path:** /api/v2/top_picks/get_top_picks_list
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/top_picks/get_top_picks_list |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/top_picks/get_top_picks_list |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/top_picks/get_top_picks_list |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/top_picks/get_top_picks_list |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/top_picks/get_top_picks_list |
