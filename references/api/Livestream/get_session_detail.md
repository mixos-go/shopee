...
category: livestream
api_name: get_session_detail
url: "https://open.shopee.com/documents/v2/v2.livestream.get_session_detail?module=125&type=1"
...
**Method:** GET
**HTTP Path:** /api/v2/livestream/get_session_detail
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/livestream/get_session_detail |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/livestream/get_session_detail |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/livestream/get_session_detail |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/livestream/get_session_detail |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/livestream/get_session_detail |
...
HttpResponse<String> response = Unirest.get("https://partner.shopeemobile.com/api/v2/livestream/get_session_detail?access_token=access_token&partner_id=partner_id&session_id=6236215&sign=sign&timestamp=timestamp&user_id=user_id")
.asString();
```
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.shopeemobile.com/api/v2/livestream/get_session_detail?access_token=access_token&partner_id=partner_id&session_id=6236215&sign=sign&timestamp=timestamp&user_id=user_id',
