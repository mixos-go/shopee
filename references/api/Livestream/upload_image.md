...
url: "https://open.shopee.com/documents/v2/v2.livestream.upload_image?module=125&type=1"
domain: open.shopee.com
date_saved: "2026-09-03 09:13:55"
...
**Method:** POST
**HTTP Path:** /api/v2/livestream/upload_image
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/livestream/upload_image |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/livestream/upload_image |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/livestream/upload_image |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/livestream/upload_image |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/livestream/upload_image |
...
| --- | --- | --- | --- | --- |
| image | file | True |  | The image file to upload. |
...
HttpResponse<String> response = Unirest.post("https://partner.shopeemobile.com/api/v2/livestream/upload_image?access_token=access_token&partner_id=partner_id&sign=sign&timestamp=timestamp&user_id=user_id")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.shopeemobile.com/api/v2/livestream/upload_image?access_token=access_token&partner_id=partner_id&sign=sign&timestamp=timestamp&user_id=user_id',
...
```bash
curl --location --request POST 'https://partner.shopeemobile.com/api/v2/livestream/upload_image?access_token=access_token&partner_id=partner_id&sign=sign&timestamp=timestamp&user_id=user_id' \
