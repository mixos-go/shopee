...
api_name: get_listings_with_issues
url: "https://open.shopee.com/documents/v2/v2.account_health.get_listings_with_issues?module=103&type=1"
...
**Category:** ACCOUNT_HEALTH
**API:** get_listings_with_issues

**Method:** GET
**HTTP Path:** /api/v2/account_health/get_listings_with_issues
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/account_health/get_listings_with_issues |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/account_health/get_listings_with_issues |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/account_health/get_listings_with_issues |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/account_health/get_listings_with_issues |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/account_health/get_listings_with_issues |
...
| reason | int32 | 1 | Reason of this item. Applicable values: 1: Prohibited 2: Counterfeit 3: Spam 4: Inappropriate Image 5: Insufficient Info 6: Mall Listing Improvement 7: Other Listing Improvement |
