...
api_name: get_late_orders
url: "https://open.shopee.com/documents/v2/v2.account_health.get_late_orders?module=103&type=1"
...
**Method:** GET
**HTTP Path:** /api/v2/account_health/get_late_orders
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/account_health/get_late_orders |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/account_health/get_late_orders |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/account_health/get_late_orders |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/account_health/get_late_orders |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/account_health/get_late_orders |
