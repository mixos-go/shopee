...
category: product
api_name: generate_kit_image
url: "https://open.shopee.com/documents/v2/v2.product.generate_kit_image?module=89&type=1"
...
**Category:** PRODUCT
**API:** generate_kit_image

**Method:** POST
**HTTP Path:** /api/v2/product/generate_kit_image
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/product/generate_kit_image |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/product/generate_kit_image |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/product/generate_kit_image |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/product/generate_kit_image |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/product/generate_kit_image |
...
| --- | --- | --- | --- | --- |
| component_list | object[] | True |  | Please send up until 9 components. |
| component_item_id | int64 | True |  | ID of the item that composes this kit model. |
| component_model_id | int64 | False |  | ID of the model that composes this kit model. |
