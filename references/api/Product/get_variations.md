...
category: product
api_name: get_variations
url: "https://open.shopee.com/documents/v2/v2.product.get_variations?module=89&type=1"
...
**Method:** GET
**HTTP Path:** /api/v2/product/get_variation_tree
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/product/get_variation_tree |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/product/get_variation_tree |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/product/get_variation_tree |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/product/get_variation_tree |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/product/get_variation_tree |
...
| --- | --- | --- | --- | --- |
| category_id | int | True |  | Leaf category id |
...
HttpResponse<String> response = Unirest.get("https://open.admin.test.shopee.io/api/v2/product/get_variations?access_token=access_token&category_id=0&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp")
.asString();
```
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://open.admin.test.shopee.io/api/v2/product/get_variations?access_token=access_token&category_id=0&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp',
