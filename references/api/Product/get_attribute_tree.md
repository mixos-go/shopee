...
date_saved: "2026-09-03 09:11:30"
...
**Method:** GET
**HTTP Path:** /api/v2/product/get_attribute_tree
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/product/get_attribute_tree |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/product/get_attribute_tree |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/product/get_attribute_tree |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/product/get_attribute_tree |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/product/get_attribute_tree |
...
HttpResponse<String> response = Unirest.get("https://open.admin.uat.shopee.io/api/v2/product/get_attribute_tree?access_token=access_token&category_ids=1234,5678&language=en&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp")
.asString();
```
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://open.admin.uat.shopee.io/api/v2/product/get_attribute_tree?access_token=access_token&category_ids=1234,5678&language=en&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp',
