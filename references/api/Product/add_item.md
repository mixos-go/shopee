...
category: product
api_name: add_item
url: "https://open.shopee.com/documents/v2/v2.product.add_item?module=89&type=1"
domain: open.shopee.com
date_saved: "2026-09-03 09:11:34"
...
**Method:** POST
**HTTP Path:** /api/v2/product/add_item
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/product/add_item |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/product/add_item |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/product/add_item |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/product/add_item |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/product/add_item |
...
| condition | string | False | NEW | Condition of item, USED、Used and used will be mapped to Used; NEW、New and new will be mapped to New. Required for BR. |
...
HttpResponse<String> response = Unirest.post("https://partner.uat.shopeemobile.com/api/v2/product/add_item?sign=sign&access_token=access_token&timestamp=timestamp&shop_id=shop_id&partner_id=partner_id")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.uat.shopeemobile.com/api/v2/product/add_item?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp',
...
```bash
curl --location --request POST 'https://partner.uat.shopeemobile.com/api/v2/product/add_item?access_token=access_token&timestamp=timestamp&shop_id=shop_id&partner_id=partner_id&sign=sign' \
--header 'Content-Type: application/json' \
--data-raw '{
   "attribute_list": [
      {
