...
url: "https://open.shopee.com/documents/v2/v2.product.search_item?module=89&type=1"
domain: open.shopee.com
date_saved: "2026-09-03 09:11:42"
...
**Method:** GET
**HTTP Path:** /api/v2/product/search_item
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/product/search_item |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/product/search_item |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/product/search_item |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/product/search_item |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/product/search_item |
...
| --- | --- | --- | --- | --- |
| offset | string | False | 0 | Specifies the starting entry of data to return in the current call. Default is empty. if data is more than one page, the offset can be some entry to start next call. |
| page_size | int | True | 10 | the size of one page. |
| item_name | string | False | apple | name of item. |
| attribute_status | int | False | 2 | 1:get item lack of requires attribute. 2:get item lack of optional attribute. |
| item_sku | string | False | sku | sku. If you search for item_sku and item_name at the same time, only the results that match item_sku will be returned. If you search for item_sku and attribute_status at the same time, the results that match both item_sku and attribute_status will be returned. |
| item_status | string[] | False | ["NORMAL"] | NORMAL/BANNED/UNLIST/ REVIEWING/SELLER_DELETE/SHOPEE_DELETE If you want to search multiple status, please upload the url like this: item_status=NORMAL&item_status=BANNED |
| deboost_only | boolean | False | true | If deboost_only is true, then API will return items whose deboost is true, if deboost_only is empty or false, then API will return items whose deboost is true and false simultaneously |
