...
category: product
api_name: boost_item
url: "https://open.shopee.com/documents/v2/v2.product.boost_item?module=89&type=1"
...
**Method:** POST
**HTTP Path:** /api/v2/product/boost_item
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/product/boost_item |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/product/boost_item |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/product/boost_item |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/product/boost_item |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/product/boost_item |
...
| --- | --- | --- | --- | --- |
| item_id_list | int64[] | True |  | Shopee's unique identifier for an item, limit:[1,5] |
