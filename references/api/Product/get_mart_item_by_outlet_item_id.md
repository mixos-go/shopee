...
category: product
api_name: get_mart_item_by_outlet_item_id
url: "https://open.shopee.com/documents/v2/v2.product.get_mart_item_by_outlet_item_id?module=89&type=1"
...
**Category:** PRODUCT
**API:** get_mart_item_by_outlet_item_id

**Method:** POST
**HTTP Path:** /api/v2/product/get_mart_item_by_outlet_item_id
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/product/get_mart_item_by_outlet_item_id |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/product/get_mart_item_by_outlet_item_id |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/product/get_mart_item_by_outlet_item_id |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/product/get_mart_item_by_outlet_item_id |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/product/get_mart_item_by_outlet_item_id |
...
| --- | --- | --- | --- | --- |
| outlet_item_id | int64 | True |  | The item ID of the item in the outlet shop. |
