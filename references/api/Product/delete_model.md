...
category: product
api_name: delete_model
url: "https://open.shopee.com/documents/v2/v2.product.delete_model?module=89&type=1"
...
**Method:** POST
**HTTP Path:** /api/v2/product/delete_model
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/product/delete_model |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/product/delete_model |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/product/delete_model |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/product/delete_model |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/product/delete_model |
...
| model_id | int64 | True | 3456 | ID of model. |
