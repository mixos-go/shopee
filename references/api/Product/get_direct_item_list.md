...
category: product
api_name: get_direct_item_list
url: "https://open.shopee.com/documents/v2/v2.product.get_direct_item_list?module=89&type=1"
...
**Category:** PRODUCT
**API:** get_direct_item_list

**Method:** GET
**HTTP Path:** /api/v2/product/get_direct_item_list
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/product/get_direct_item_list |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/product/get_direct_item_list |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/product/get_direct_item_list |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/product/get_direct_item_list |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/product/get_direct_item_list |
...
| --- | --- | --- | --- | --- |
| main_item_id | int64[] | True | 801931707 | Item id of main shop. |
