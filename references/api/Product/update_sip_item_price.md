...
category: product
api_name: update_sip_item_price
url: "https://open.shopee.com/documents/v2/v2.product.update_sip_item_price?module=89&type=1"
...
**Category:** PRODUCT
**API:** update_sip_item_price

**Method:** POST
**HTTP Path:** /api/v2/product/update_sip_item_price
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/product/update_sip_item_price |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/product/update_sip_item_price |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/product/update_sip_item_price |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/product/update_sip_item_price |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/product/update_sip_item_price |
...
| --- | --- | --- | --- | --- |
| item_id | int | True | 1000 | ID of item. |
| sip_item_price | object[] | False |  |  |
| model_id | int | False |  | 0 for no model item. |
| sip_item_price | float | True |  | SIP item price. |
