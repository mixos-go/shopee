...
url: "https://open.shopee.com/documents/v2/v2.product.get_item_list?module=89&type=1"
...
**Method:** GET
**HTTP Path:** /api/v2/product/get_item_list
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/product/get_item_list |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/product/get_item_list |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/product/get_item_list |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/product/get_item_list |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/product/get_item_list |
...
| --- | --- | --- | --- | --- |
| offset | int64 | True | 0 | Specifies the starting entry of data to return in the current call. Default is 0. if data is more than one page, the offset can be some entry to start next call. |
...
| item_status | string[] | True | ["NORMAL"] | NORMAL/BANNED/UNLIST/ REVIEWING/SELLER_DELETE/SHOPEE_DELETE If you want to search multiple status, please upload the url like this: item_status=NORMAL&item_status=BANNED |
