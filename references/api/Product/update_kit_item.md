...
category: product
api_name: update_kit_item
url: "https://open.shopee.com/documents/v2/v2.product.update_kit_item?module=89&type=1"
domain: open.shopee.com
date_saved: "2026-09-03 09:11:49"
...
**Method:** POST
**HTTP Path:** /api/v2/product/update_kit_item
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/product/update_kit_item |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/product/update_kit_item |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/product/update_kit_item |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/product/update_kit_item |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/product/update_kit_item |
...
| item_name | string | False | item name sample | The name of this kit item. |
...
| logistic_info | object[] | False |  | Logistic channel setting. |
...
| days_to_ship | int64 | False | 10 | The guaranteed days to ship orders. Please get the days_to_ship range from get_kit_item_limit api. |
...
| original_price | float | False | 38.3 | Original price of this kit model. |
...
| tier_variation_list | object[] | False |  | Tier variation info list. Only support one tier variation, and each kit item can have from 1 to 9 kit variations. |
...
```bash
curl --location --request POST 'https://partner.uat.shopeemobile.com/api/v2/product/update_kit_item?access_token=access_token&partner_id=partner_id&shop_id=shop_id&sign=sign&timestamp=timestamp' \
--header 'Content-Type: application/json' \
--data-raw '{
   "item_id": 0,
   "item_setting": {
