...
category: product
api_name: get_direct_shop_recommended_price
url: "https://open.shopee.com/documents/v2/v2.product.get_direct_shop_recommended_price?module=89&type=1"
...
**Category:** PRODUCT
**API:** get_direct_shop_recommended_price

**Method:** GET
**HTTP Path:** /api/v2/product/get_direct_shop_recommended_price
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/product/get_direct_shop_recommended_price |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/product/get_direct_shop_recommended_price |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/product/get_direct_shop_recommended_price |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/product/get_direct_shop_recommended_price |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/product/get_direct_shop_recommended_price |
...
| --- | --- | --- | --- | --- |
| main_item_id | int64 | True | 843997552 |  |
| direct_shop_regions | string[] | True | ["SG"] | Direct shop regions. |
| category_id | int64 | False | 1234 | Main_item's category. |
| model_list | object[] | False |  | Main model model info. |
| model_id | int64 | False | 1234 | Id of main model. |
| tier_index | int64[] | False | [0,1] | Tier index of main model. Index starts from 0. |
| input_price | int64 | False | 1000 |  |
| weight | float | False | 1.1 |  |
| enabled_channel_id_list | int64[] | False | 28016 | direct shop enabled channel |
