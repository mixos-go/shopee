...
url: "https://open.shopee.com/documents/v2/v2.product.get_item_extra_info?module=89&type=1"
domain: open.shopee.com
date_saved: "2026-09-03 09:11:33"
...
**Method:** GET
**HTTP Path:** /api/v2/product/get_item_extra_info
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/product/get_item_extra_info |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/product/get_item_extra_info |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/product/get_item_extra_info |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/product/get_item_extra_info |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/product/get_item_extra_info |
