...
**Method:** GET
**HTTP Path:** /api/v2/product/get_category
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/product/get_category |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/product/get_category |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/product/get_category |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/product/get_category |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/product/get_category |
