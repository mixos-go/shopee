...
category: product
api_name: get_mart_item_mapping_by_id
url: "https://open.shopee.com/documents/v2/v2.product.get_mart_item_mapping_by_id?module=89&type=1"
...
**Category:** PRODUCT
**API:** get_mart_item_mapping_by_id

**Method:** POST
**HTTP Path:** /api/v2/product/get_mart_item_mapping_by_id
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/product/get_mart_item_mapping_by_id |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/product/get_mart_item_mapping_by_id |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/product/get_mart_item_mapping_by_id |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/product/get_mart_item_mapping_by_id |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/product/get_mart_item_mapping_by_id |
...
| outlet_shop_id_list | int64[] | True |  | A list of outlet shop IDs used to filter the mapping results. |
