...
url: "https://open.shopee.com/documents/v2/v2.product.delete_item?module=89&type=1"
...
**Method:** POST
**HTTP Path:** /api/v2/product/delete_item
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/product/delete_item |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/product/delete_item |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/product/delete_item |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/product/delete_item |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/product/delete_item |
...
| --- | --- | --- | --- | --- |
| item_id | int64 | True | 34001 | The identity of product item. |
