...
category: product
api_name: unlist_item
url: "https://open.shopee.com/documents/v2/v2.product.unlist_item?module=89&type=1"
...
**Method:** POST
**HTTP Path:** /api/v2/product/unlist_item
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/product/unlist_item |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/product/unlist_item |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/product/unlist_item |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/product/unlist_item |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/product/unlist_item |
...
| --- | --- | --- | --- | --- |
| item_list | object[] | True |  | Length should be between 1 to 50. |
| item_id | int64 | True | 2300069665 | Shopee's unique identifier for an item |
| unlist | boolean | True | true | Unlist or not |
