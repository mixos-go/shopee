...
url: "https://open.shopee.com/documents/v2/v2.product.get_boosted_list?module=89&type=1"
...
**Category:** PRODUCT
**API:** get_boosted_list

**Method:** GET
**HTTP Path:** /api/v2/product/get_boosted_list
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/product/get_boosted_list |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/product/get_boosted_list |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/product/get_boosted_list |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/product/get_boosted_list |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/product/get_boosted_list |
