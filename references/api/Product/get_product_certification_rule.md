...
category: product
api_name: get_product_certification_rule
url: "https://open.shopee.com/documents/v2/v2.product.get_product_certification_rule?module=89&type=1"
...
**Category:** PRODUCT
**API:** get_product_certification_rule

**Method:** POST
**HTTP Path:** /api/v2/product/get_product_certification_rule
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/product/get_product_certification_rule |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/product/get_product_certification_rule |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/product/get_product_certification_rule |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/product/get_product_certification_rule |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/product/get_product_certification_rule |
...
| category_id | int64 | False |  | ID of category. |
