...
url: "https://open.shopee.com/documents/v2/v2.product.category_recommend?module=89&type=1"
...
**Method:** GET
**HTTP Path:** /api/v2/product/category_recommend
...
| --- | --- | --- |
| Live | Global | https://partner.shopeemobile.com/api/v2/product/category_recommend |
| Live | Chinese Mainland | https://openplatform.shopee.cn/api/v2/product/category_recommend |
| Live | Brazil | https://openplatform.shopee.com.br/api/v2/product/category_recommend |
| Sandbox | Global | https://openplatform.sandbox.test-stable.shopee.sg/api/v2/product/category_recommend |
| Sandbox | Chinese Mainland | https://openplatform.sandbox.test-stable.shopee.cn/api/v2/product/category_recommend |
...
| --- | --- | --- | --- | --- |
| item_name | string | True | 海飞丝洗发水 | name of item |
| product_cover_image | string | False | 16bdad2c365f1fccea7664e69b696571 | Please use the image id returned by v2.media_space.upload_image api, we will ignore if this field is empty string |
